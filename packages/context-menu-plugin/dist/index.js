...
class ContextMenuView extends term.TemplateEngine {
...
class ContextMenu extends term.Plugin {
    constructor() {
        super(...arguments);
    ...
    render(content) {
        ...
        this.isVisible = false;
        return lodashEs.isString(content) ? root.innerHTML = content : root.appendChild(content);
    }
    updatePosition() {
