...
function isString$1(value) {
  return typeof value == 'string' || !isArray$2(value) && isObjectLike$2(value) && baseGetTag$2(value) == stringTag$4;
}

var template$1 = "<div ref=\"root\" class=\"root\"></div>\n";
...
class ContextMenu extends Plugin {
    ...
    render(content) {
        ...
        this.isVisible = false;
        return isString$1(content) ? root.innerHTML = content : root.appendChild(content);
    }
    updatePosition() {
...
exports.CLOSE_ACTION = CLOSE_ACTION;
exports.ContextMenu = ContextMenu;
exports.END_OF_LINE_TYPE = END_OF_LINE_TYPE;
exports.POSITION_TARGET_TYPE = POSITION_TARGET_TYPE;
