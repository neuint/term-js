...
module.exports = {
  ...
  target: 'web',
  entry: path.resolve(__dirname, isProduction ? './src/index.ts' : './src/start.ts'),
  ...
  externals: {},
  plugins: [
    new MiniCssExtractPlugin({ filename: 'term-js-context-menu-plugin.css' }),
