...
const DATA_INDEX_ATTRIBUTE_NAME$1 = 'modals-plugin-data-index';
...
class ModalView extends TemplateEngine {
    constructor(container, options) {
        ...
        this.onActionClick = (e) => {
            ...
            const dataIndexValue = target.getAttribute(DATA_INDEX_ATTRIBUTE_NAME$1);
    ...
    get normalizedActions() {
        ...
        if (!actions.length)
            return [];
        return (isArray$2(actions[0]) ? actions : [actions]);
    }
    render() {
        if (this.isRendered)
            return;
    ...
    renderActions() {
        ...
        normalizedActions.forEach((actionsLine, lineIndex) => {
            ...
            actionsLine.forEach((action, itemIndex) => {
                ...
                actionButton.setAttribute(DATA_INDEX_ATTRIBUTE_NAME$1, String(itemIndex));
...
class Modals extends Plugin {
    constructor() {
        ...
        this.hideLast = () => {
            ...
            const lastModal = last$2(modalStack);
