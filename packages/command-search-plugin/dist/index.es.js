...
/** Used for built-in method references. */
var objectProto$1$2$1$1 = Object.prototype;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
 * of values.
...
var nativeObjectToString$1$2$1$1 = objectProto$1$2$1$1.toString;
/**
 * Converts `value` to a string using `Object.prototype.toString`.
 *
 * @private
...
function objectToString$2$1$1(value) {
  return nativeObjectToString$1$2$1$1.call(value);
}
...
var symToStringTag$1$2$1$1 = Symbol$2$1$1 ? Symbol$2$1$1.toStringTag : undefined;
/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
...
function baseGetTag$2$1$1(value) {
  ...
  return symToStringTag$1$2$1$1 && symToStringTag$1$2$1$1 in Object(value) ? getRawTag$2$1$1(value) : objectToString$2$1$1(value);
}
...
var symbolTag$4$1$1 = '[object Symbol]';
/**
 * Checks if `value` is classified as a `Symbol` primitive or object.
 *
 * @static
...
function isSymbol$2$1$1(value) {
  return typeof value == 'symbol' || isObjectLike$2$1$1(value) && baseGetTag$2$1$1(value) == symbolTag$4$1$1;
}
 ...
 * @returns {Array} Returns the new mapped array.
 */
function arrayMap$2$1$1(array, iteratee) {
  var index = -1,
      length = array == null ? 0 : array.length,
      result = Array(length);
...
var INFINITY$3$1$1 = 1 / 0;
/** Used to convert symbols to primitives and strings. */

var symbolProto$3$1$1 = Symbol$2$1$1 ? Symbol$2$1$1.prototype : undefined,
    symbolToString$2$1$1 = symbolProto$3$1$1 ? symbolProto$3$1$1.toString : undefined;
/**
 * The base implementation of `_.toString` which doesn't convert nullish
 * values to empty strings.
 *
...
function baseToString$2$1$1(value) {
  // Exit early for strings to avoid a performance hit in some environments.
  if (typeof value == 'string') {
    return value;
  }

  if (isArray$2$1$1(value)) {
    // Recursively convert values (susceptible to call stack limits).
    return arrayMap$2$1$1(value, baseToString$2$1$1) + '';
  }

  if (isSymbol$2$1$1(value)) {
    return symbolToString$2$1$1 ? symbolToString$2$1$1.call(value) : '';
  }

  var result = value + '';
  return result == '0' && 1 / value == -INFINITY$3$1$1 ? '-0' : result;
}
 ...
 * // => true
 */
function identity$1$1$1(value) {
  return value;
}

/** `Object#toString` result references. */

var asyncTag$2$1$1 = '[object AsyncFunction]',
    funcTag$4$1$1 = '[object Function]',
    genTag$3$1$1 = '[object GeneratorFunction]',
    proxyTag$2$1$1 = '[object Proxy]';
/**
 * Checks if `value` is classified as a `Function` object.
 *
 * @static
...
function isFunction$2$1$1(value) {
  if (!isObject$2$1$1(value)) {
    return false;
  } // The use of `Object#toString` avoids issues with the `typeof` operator
  // in Safari 9 which returns 'object' for typed arrays and other constructors.


  var tag = baseGetTag$2$1$1(value);
  return tag == funcTag$4$1$1 || tag == genTag$3$1$1 || tag == asyncTag$2$1$1 || tag == proxyTag$2$1$1;
}

/** Used to detect overreaching core-js shims. */

var coreJsData$2$1$1 = root$2$1$1['__core-js_shared__'];

/** Used to detect methods masquerading as native. */

var maskSrcKey$2$1$1 = function () {
  var uid = /[^.]+$/.exec(coreJsData$2$1$1 && coreJsData$2$1$1.keys && coreJsData$2$1$1.keys.IE_PROTO || '');
  return uid ? 'Symbol(src)_1.' + uid : '';
}();
/**
 * Checks if `func` has its source masked.
...
function isMasked$2$1$1(func) {
  return !!maskSrcKey$2$1$1 && maskSrcKey$2$1$1 in func;
}

/** Used for built-in method references. */
var funcProto$4$1$1 = Function.prototype;
/** Used to resolve the decompiled source of functions. */

var funcToString$4$1$1 = funcProto$4$1$1.toString;
/**
 * Converts `func` to its source code.
 *
 * @private
...
function toSource$2$1$1(func) {
  if (func != null) {
    try {
      return funcToString$4$1$1.call(func);
    } catch (e) {}
...
var reRegExpChar$2$1$1 = /[\\^$.*+?()[\]{}|]/g;
/** Used to detect host constructors (Safari). */

var reIsHostCtor$2$1$1 = /^\[object .+?Constructor\]$/;
/** Used for built-in method references. */

var funcProto$1$2$1$1 = Function.prototype,
    objectProto$2$2$1$1 = Object.prototype;
/** Used to resolve the decompiled source of functions. */

var funcToString$1$2$1$1 = funcProto$1$2$1$1.toString;
/** Used to check objects for own properties. */

var hasOwnProperty$1$2$1$1 = objectProto$2$2$1$1.hasOwnProperty;
/** Used to detect if a method is native. */

var reIsNative$2$1$1 = RegExp('^' + funcToString$1$2$1$1.call(hasOwnProperty$1$2$1$1).replace(reRegExpChar$2$1$1, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
/**
 * The base implementation of `_.isNative` without bad shim checks.
 *
 * @private
...
function baseIsNative$2$1$1(value) {
  if (!isObject$2$1$1(value) || isMasked$2$1$1(value)) {
    return false;
  }

  var pattern = isFunction$2$1$1(value) ? reIsNative$2$1$1 : reIsHostCtor$2$1$1;
  return pattern.test(toSource$2$1$1(value));
}
 ...
 * @returns {*} Returns the property value.
 */
function getValue$2$1$1(object, key) {
  return object == null ? undefined : object[key];
}
...
function getNative$2$1$1(object, key) {
  var value = getValue$2$1$1(object, key);
  return baseIsNative$2$1$1(value) ? value : undefined;
}

/* Built-in method references that are verified to be native. */

var WeakMap$1$1$1$1 = getNative$2$1$1(root$2$1$1, 'WeakMap');

/** Built-in value references. */

var objectCreate$1$1$1 = Object.create;
/**
 * The base implementation of `_.create` without support for assigning
 * properties to the created object.
 *
...
var baseCreate$1$1$1 = function () {
  function object() {}

  return function (proto) {
    if (!isObject$2$1$1(proto)) {
      return {};
    }

    if (objectCreate$1$1$1) {
      return objectCreate$1$1$1(proto);
    }
 ...
 * @returns {*} Returns the result of `func`.
 */
function apply$1$1$1(func, thisArg, args) {
  switch (args.length) {
    case 0:
      return func.call(thisArg);
 ...
 * @returns {Array} Returns `array`.
 */
function copyArray$1$1$1(source, array) {
  var index = -1,
      length = source.length;
  array || (array = Array(length));
...
/** Used to detect hot functions by number of calls within a span of milliseconds. */
var HOT_COUNT$1$1$1 = 800,
    HOT_SPAN$1$1$1 = 16;
/* Built-in method references for those with the same name as other `lodash` methods. */

var nativeNow$1$1$1 = Date.now;
/**
 * Creates a function that'll short out and invoke `identity` instead
 * of `func` when it's called `HOT_COUNT` or more times in `HOT_SPAN`
 * milliseconds.
...
function shortOut$1$1$1(func) {
  var count = 0,
      lastCalled = 0;
  return function () {
    var stamp = nativeNow$1$1$1(),
        remaining = HOT_SPAN$1$1$1 - (stamp - lastCalled);
    lastCalled = stamp;

    if (remaining > 0) {
      if (++count >= HOT_COUNT$1$1$1) {
        return arguments[0];
      }
    } else {
      count = 0;
 ...
 * // => true
 */
function constant$1$1$1(value) {
  return function () {
    return value;
  };
}

var defineProperty$1$1$1 = function () {
  try {
    var func = getNative$2$1$1(Object, 'defineProperty');
    func({}, '', {});
    return func;
  } catch (e) {}
}();
...
var baseSetToString$1$1$1 = !defineProperty$1$1$1 ? identity$1$1$1 : function (func, string) {
  return defineProperty$1$1$1(func, 'toString', {
    'configurable': true,
    'enumerable': false,
    'value': constant$1$1$1(string),
    'writable': true
  });
};
...
var setToString$1$1$1 = shortOut$1$1$1(baseSetToString$1$1$1);
 ...
 * @returns {Array} Returns `array`.
 */
function arrayEach$1$1$1(array, iteratee) {
  var index = -1,
      length = array == null ? 0 : array.length;
...
/** Used as references for various `Number` constants. */
var MAX_SAFE_INTEGER$2$1$1 = 9007199254740991;
/** Used to detect unsigned integer values. */

var reIsUint$1$1$1 = /^(?:0|[1-9]\d*)$/;
/**
 * Checks if `value` is a valid array-like index.
 *
 * @private
...
function isIndex$1$1$1(value, length) {
  var type = typeof value;
  length = length == null ? MAX_SAFE_INTEGER$2$1$1 : length;
  return !!length && (type == 'number' || type != 'symbol' && reIsUint$1$1$1.test(value)) && value > -1 && value % 1 == 0 && value < length;
}
...
function baseAssignValue$1$1$1(object, key, value) {
  if (key == '__proto__' && defineProperty$1$1$1) {
    defineProperty$1$1$1(object, key, {
      'configurable': true,
      'enumerable': true,
      'value': value,
      'writable': true
 ...
 * // => true
 */
function eq$2$1$1(value, other) {
  return value === other || value !== value && other !== other;
}

/** Used for built-in method references. */

var objectProto$3$2$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$2$2$1$1 = objectProto$3$2$1$1.hasOwnProperty;
/**
 * Assigns `value` to `key` of `object` if the existing value is not equivalent
 * using [`SameValueZero`](http://ecma-international.org/ecma-262/7.0/#sec-samevaluezero)
 * for equality comparisons.
...
function assignValue$1$1$1(object, key, value) {
  var objValue = object[key];

  if (!(hasOwnProperty$2$2$1$1.call(object, key) && eq$2$1$1(objValue, value)) || value === undefined && !(key in object)) {
    baseAssignValue$1$1$1(object, key, value);
  }
}
...
function copyObject$1$1$1(source, props, object, customizer) {
  var isNew = !object;
  object || (object = {});
  var index = -1,
      length = props.length;
  ...
  while (++index < length) {
    ...
    if (isNew) {
      baseAssignValue$1$1$1(object, key, newValue);
    } else {
      assignValue$1$1$1(object, key, newValue);
    }
  }
...
function overRest$1$1$1(func, start, transform) {
  start = nativeMax$1$1$1(start === undefined ? func.length - 1 : start, 0);
  return function () {
    var args = arguments,
        index = -1,
        length = nativeMax$1$1$1(args.length - start, 0),
        array = Array(length);
    ...
    otherArgs[start] = transform(array);
    return apply$1$1$1(func, this, otherArgs);
  };
}
...
function baseRest$1$1$1(func, start) {
  return setToString$1$1$1(overRest$1$1$1(func, start, identity$1$1$1), func + '');
}

/** Used as references for various `Number` constants. */
var MAX_SAFE_INTEGER$1$1$1$1 = 9007199254740991;
/**
 * Checks if `value` is a valid array-like length.
 *
 * **Note:** This method is loosely based on
...
function isLength$1$1$1(value) {
  return typeof value == 'number' && value > -1 && value % 1 == 0 && value <= MAX_SAFE_INTEGER$1$1$1$1;
}
...
function isArrayLike$1$1$1(value) {
  return value != null && isLength$1$1$1(value.length) && !isFunction$2$1$1(value);
}
...
function isIterateeCall$1$1$1(value, index, object) {
  if (!isObject$2$1$1(object)) {
    return false;
  }

  var type = typeof index;

  if (type == 'number' ? isArrayLike$1$1$1(object) && isIndex$1$1$1(index, object.length) : type == 'string' && index in object) {
    return eq$2$1$1(object[index], value);
  }
...
function createAssigner$1$1$1(assigner) {
  return baseRest$1$1$1(function (object, sources) {
    var index = -1,
        length = sources.length,
        customizer = length > 1 ? sources[length - 1] : undefined,
        guard = length > 2 ? sources[2] : undefined;
    ...
    if (guard && isIterateeCall$1$1$1(sources[0], sources[1], guard)) {
      customizer = length < 3 ? undefined : customizer;
      length = 1;
    }
...
/** Used for built-in method references. */
var objectProto$4$2$1$1 = Object.prototype;
/**
 * Checks if `value` is likely a prototype object.
 *
 * @private
...
function isPrototype$1$1$1(value) {
  var Ctor = value && value.constructor,
      proto = typeof Ctor == 'function' && Ctor.prototype || objectProto$4$2$1$1;
  return value === proto;
}
 ...
 * @returns {Array} Returns the array of results.
 */
function baseTimes$1$1$1(n, iteratee) {
  var index = -1,
      result = Array(n);
...
var argsTag$3$1$1 = '[object Arguments]';
/**
 * The base implementation of `_.isArguments`.
 *
 * @private
...
function baseIsArguments$1$1$1(value) {
  return isObjectLike$2$1$1(value) && baseGetTag$2$1$1(value) == argsTag$3$1$1;
}

/** Used for built-in method references. */

var objectProto$5$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$3$2$1$1 = objectProto$5$1$1$1.hasOwnProperty;
/** Built-in value references. */

var propertyIsEnumerable$2$1$1 = objectProto$5$1$1$1.propertyIsEnumerable;
/**
 * Checks if `value` is likely an `arguments` object.
 *
 * @static
...
var isArguments$1$1$1 = baseIsArguments$1$1$1(function () {
  return arguments;
}()) ? baseIsArguments$1$1$1 : function (value) {
  return isObjectLike$2$1$1(value) && hasOwnProperty$3$2$1$1.call(value, 'callee') && !propertyIsEnumerable$2$1$1.call(value, 'callee');
};
 ...
 * // => [false, false]
 */
function stubFalse$1$1$1() {
  return false;
}

/** Detect free variable `exports`. */

var freeExports$3$1$1 = typeof exports == 'object' && exports && !exports.nodeType && exports;
/** Detect free variable `module`. */

var freeModule$3$1$1 = freeExports$3$1$1 && typeof module == 'object' && module && !module.nodeType && module;
/** Detect the popular CommonJS extension `module.exports`. */

var moduleExports$3$1$1 = freeModule$3$1$1 && freeModule$3$1$1.exports === freeExports$3$1$1;
/** Built-in value references. */

var Buffer$2$1$1 = moduleExports$3$1$1 ? root$2$1$1.Buffer : undefined;
/* Built-in method references for those with the same name as other `lodash` methods. */

var nativeIsBuffer$1$1$1 = Buffer$2$1$1 ? Buffer$2$1$1.isBuffer : undefined;
/**
 * Checks if `value` is a buffer.
 *
 * @static
...
var isBuffer$1$1$1 = nativeIsBuffer$1$1$1 || stubFalse$1$1$1;

/** `Object#toString` result references. */

var argsTag$1$1$1$1 = '[object Arguments]',
    arrayTag$2$1$1 = '[object Array]',
    boolTag$3$1$1 = '[object Boolean]',
    dateTag$3$1$1 = '[object Date]',
    errorTag$3$1$1 = '[object Error]',
    funcTag$1$1$1$1 = '[object Function]',
    mapTag$5$1$1 = '[object Map]',
    numberTag$3$1$1 = '[object Number]',
    objectTag$4$1$1 = '[object Object]',
    regexpTag$3$1$1 = '[object RegExp]',
    setTag$5$1$1 = '[object Set]',
    stringTag$4$1$1 = '[object String]',
    weakMapTag$3$1$1 = '[object WeakMap]';
var arrayBufferTag$3$1$1 = '[object ArrayBuffer]',
    dataViewTag$4$1$1 = '[object DataView]',
    float32Tag$3$1$1 = '[object Float32Array]',
    float64Tag$3$1$1 = '[object Float64Array]',
    int8Tag$3$1$1 = '[object Int8Array]',
    int16Tag$3$1$1 = '[object Int16Array]',
    int32Tag$3$1$1 = '[object Int32Array]',
    uint8Tag$3$1$1 = '[object Uint8Array]',
    uint8ClampedTag$3$1$1 = '[object Uint8ClampedArray]',
    uint16Tag$3$1$1 = '[object Uint16Array]',
    uint32Tag$3$1$1 = '[object Uint32Array]';
/** Used to identify `toStringTag` values of typed arrays. */

var typedArrayTags$1$1$1 = {};
typedArrayTags$1$1$1[float32Tag$3$1$1] = typedArrayTags$1$1$1[float64Tag$3$1$1] = typedArrayTags$1$1$1[int8Tag$3$1$1] = typedArrayTags$1$1$1[int16Tag$3$1$1] = typedArrayTags$1$1$1[int32Tag$3$1$1] = typedArrayTags$1$1$1[uint8Tag$3$1$1] = typedArrayTags$1$1$1[uint8ClampedTag$3$1$1] = typedArrayTags$1$1$1[uint16Tag$3$1$1] = typedArrayTags$1$1$1[uint32Tag$3$1$1] = true;
typedArrayTags$1$1$1[argsTag$1$1$1$1] = typedArrayTags$1$1$1[arrayTag$2$1$1] = typedArrayTags$1$1$1[arrayBufferTag$3$1$1] = typedArrayTags$1$1$1[boolTag$3$1$1] = typedArrayTags$1$1$1[dataViewTag$4$1$1] = typedArrayTags$1$1$1[dateTag$3$1$1] = typedArrayTags$1$1$1[errorTag$3$1$1] = typedArrayTags$1$1$1[funcTag$1$1$1$1] = typedArrayTags$1$1$1[mapTag$5$1$1] = typedArrayTags$1$1$1[numberTag$3$1$1] = typedArrayTags$1$1$1[objectTag$4$1$1] = typedArrayTags$1$1$1[regexpTag$3$1$1] = typedArrayTags$1$1$1[setTag$5$1$1] = typedArrayTags$1$1$1[stringTag$4$1$1] = typedArrayTags$1$1$1[weakMapTag$3$1$1] = false;
/**
 * The base implementation of `_.isTypedArray` without Node.js optimizations.
 *
 * @private
...
function baseIsTypedArray$1$1$1(value) {
  return isObjectLike$2$1$1(value) && isLength$1$1$1(value.length) && !!typedArrayTags$1$1$1[baseGetTag$2$1$1(value)];
}
...
var freeExports$1$1$1$1 = typeof exports == 'object' && exports && !exports.nodeType && exports;
/** Detect free variable `module`. */

var freeModule$1$1$1$1 = freeExports$1$1$1$1 && typeof module == 'object' && module && !module.nodeType && module;
/** Detect the popular CommonJS extension `module.exports`. */

var moduleExports$1$1$1$1 = freeModule$1$1$1$1 && freeModule$1$1$1$1.exports === freeExports$1$1$1$1;
/** Detect free variable `process` from Node.js. */

var freeProcess$1$1$1 = moduleExports$1$1$1$1 && freeGlobal$2$1$1.process;
/** Used to access faster Node.js helpers. */

var nodeUtil$1$1$1 = function () {
  try {
    // Use `util.types` for Node.js 10+.
    var types = freeModule$1$1$1$1 && freeModule$1$1$1$1.require && freeModule$1$1$1$1.require('util').types;
    ...
    return freeProcess$1$1$1 && freeProcess$1$1$1.binding && freeProcess$1$1$1.binding('util');
  } catch (e) {}
}();

/* Node.js helper references. */

var nodeIsTypedArray$1$1$1 = nodeUtil$1$1$1 && nodeUtil$1$1$1.isTypedArray;
/**
 * Checks if `value` is classified as a typed array.
 *
 * @static
...
var isTypedArray$1$1$1 = nodeIsTypedArray$1$1$1 ? baseUnary$1$1$1(nodeIsTypedArray$1$1$1) : baseIsTypedArray$1$1$1;

/** Used for built-in method references. */

var objectProto$6$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$4$1$1$1 = objectProto$6$1$1$1.hasOwnProperty;
/**
 * Creates an array of the enumerable property names of the array-like `value`.
 *
 * @private
...
function arrayLikeKeys$1$1$1(value, inherited) {
  var isArr = isArray$2$1$1(value),
      isArg = !isArr && isArguments$1$1$1(value),
      isBuff = !isArr && !isArg && isBuffer$1$1$1(value),
      isType = !isArr && !isArg && !isBuff && isTypedArray$1$1$1(value),
      skipIndexes = isArr || isArg || isBuff || isType,
      result = skipIndexes ? baseTimes$1$1$1(value.length, String) : [],
      length = result.length;

  for (var key in value) {
    if ((inherited || hasOwnProperty$4$1$1$1.call(value, key)) && !(skipIndexes && ( // Safari 9 has enumerable `arguments.length` in strict mode.
    key == 'length' || // Node.js 0.10 has enumerable non-index properties on buffers.
    isBuff && (key == 'offset' || key == 'parent') || // PhantomJS 2 has enumerable non-index properties on typed arrays.
    isType && (key == 'buffer' || key == 'byteLength' || key == 'byteOffset') || // Skip index properties.
    isIndex$1$1$1(key, length)))) {
      result.push(key);
    }
  }
 ...
 * @returns {Function} Returns the new function.
 */
function overArg$1$1$1(func, transform) {
  return function (arg) {
    return func(transform(arg));
  };
}
...
var nativeKeys$1$1$1 = overArg$1$1$1(Object.keys, Object);

/** Used for built-in method references. */

var objectProto$7$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$5$1$1$1 = objectProto$7$1$1$1.hasOwnProperty;
/**
 * The base implementation of `_.keys` which doesn't treat sparse arrays as dense.
 *
 * @private
...
function baseKeys$1$1$1(object) {
  if (!isPrototype$1$1$1(object)) {
    return nativeKeys$1$1$1(object);
  }

  var result = [];

  for (var key in Object(object)) {
    if (hasOwnProperty$5$1$1$1.call(object, key) && key != 'constructor') {
      result.push(key);
    }
  }
...
function keys$1$1$1(object) {
  return isArrayLike$1$1$1(object) ? arrayLikeKeys$1$1$1(object) : baseKeys$1$1$1(object);
}
 ...
 * @returns {Array} Returns the array of property names.
 */
function nativeKeysIn$1$1$1(object) {
  var result = [];
...
var objectProto$8$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$6$1$1$1 = objectProto$8$1$1$1.hasOwnProperty;
/**
 * The base implementation of `_.keysIn` which doesn't treat sparse arrays as dense.
 *
 * @private
...
function baseKeysIn$1$1$1(object) {
  if (!isObject$2$1$1(object)) {
    return nativeKeysIn$1$1$1(object);
  }

  var isProto = isPrototype$1$1$1(object),
      result = [];

  for (var key in object) {
    if (!(key == 'constructor' && (isProto || !hasOwnProperty$6$1$1$1.call(object, key)))) {
      result.push(key);
    }
  }
...
function keysIn$1$1$1$1(object) {
  return isArrayLike$1$1$1(object) ? arrayLikeKeys$1$1$1(object, true) : baseKeysIn$1$1$1(object);
}
...
var assignInWith$1$1$1 = createAssigner$1$1$1(function (object, source, srcIndex, customizer) {
  copyObject$1$1$1(source, keysIn$1$1$1$1(source), object, customizer);
});

/** Used to match property names within property paths. */

var reIsDeepProp$2$1$1 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
    reIsPlainProp$2$1$1 = /^\w*$/;
/**
 * Checks if `value` is a property name and not a property path.
 *
 * @private
...
function isKey$2$1$1(value, object) {
  if (isArray$2$1$1(value)) {
    return false;
  }
  ...
  if (type == 'number' || type == 'symbol' || type == 'boolean' || value == null || isSymbol$2$1$1(value)) {
    return true;
  }

  return reIsPlainProp$2$1$1.test(value) || !reIsDeepProp$2$1$1.test(value) || object != null && value in Object(object);
}

/* Built-in method references that are verified to be native. */

var nativeCreate$2$1$1 = getNative$2$1$1(Object, 'create');
...
function hashClear$2$1$1() {
  this.__data__ = nativeCreate$2$1$1 ? nativeCreate$2$1$1(null) : {};
  this.size = 0;
}
...
var HASH_UNDEFINED$3$1$1 = '__lodash_hash_undefined__';
/** Used for built-in method references. */

var objectProto$9$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$7$1$1$1 = objectProto$9$1$1$1.hasOwnProperty;
/**
 * Gets the hash value for `key`.
 *
 * @private
...
function hashGet$2$1$1(key) {
  var data = this.__data__;

  if (nativeCreate$2$1$1) {
    var result = data[key];
    return result === HASH_UNDEFINED$3$1$1 ? undefined : result;
  }

  return hasOwnProperty$7$1$1$1.call(data, key) ? data[key] : undefined;
}

/** Used for built-in method references. */

var objectProto$a$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$8$1$1$1 = objectProto$a$1$1$1.hasOwnProperty;
/**
 * Checks if a hash value for `key` exists.
 *
 * @private
...
function hashHas$2$1$1(key) {
  var data = this.__data__;
  return nativeCreate$2$1$1 ? data[key] !== undefined : hasOwnProperty$8$1$1$1.call(data, key);
}

/** Used to stand-in for `undefined` hash values. */

var HASH_UNDEFINED$1$2$1$1 = '__lodash_hash_undefined__';
/**
 * Sets the hash `key` to `value`.
 *
 * @private
...
function hashSet$2$1$1(key, value) {
  var data = this.__data__;
  this.size += this.has(key) ? 0 : 1;
  data[key] = nativeCreate$2$1$1 && value === undefined ? HASH_UNDEFINED$1$2$1$1 : value;
  return this;
}
...
Hash$2$1$1.prototype.clear = hashClear$2$1$1;
Hash$2$1$1.prototype['delete'] = hashDelete$2$1$1;
Hash$2$1$1.prototype.get = hashGet$2$1$1;
Hash$2$1$1.prototype.has = hashHas$2$1$1;
Hash$2$1$1.prototype.set = hashSet$2$1$1;
...
function assocIndexOf$2$1$1(array, key) {
  var length = array.length;

  while (length--) {
    if (eq$2$1$1(array[length][0], key)) {
      return length;
    }
  }
...
var arrayProto$2$1$1 = Array.prototype;
/** Built-in value references. */

var splice$2$1$1 = arrayProto$2$1$1.splice;
/**
 * Removes `key` and its value from the list cache.
 *
 * @private
...
function listCacheDelete$2$1$1(key) {
  var data = this.__data__,
      index = assocIndexOf$2$1$1(data, key);
  ...
  if (index == lastIndex) {
    ...
    splice$2$1$1.call(data, index, 1);
  }
...
function listCacheGet$2$1$1(key) {
  var data = this.__data__,
      index = assocIndexOf$2$1$1(data, key);
  return index < 0 ? undefined : data[index][1];
}
...
function listCacheHas$2$1$1(key) {
  return assocIndexOf$2$1$1(this.__data__, key) > -1;
}
...
function listCacheSet$2$1$1(key, value) {
  var data = this.__data__,
      index = assocIndexOf$2$1$1(data, key);
...
function ListCache$2$1$1(entries) {
  var index = -1,
      length = entries == null ? 0 : entries.length;
  this.clear();
...
ListCache$2$1$1.prototype.clear = listCacheClear$2$1$1;
ListCache$2$1$1.prototype['delete'] = listCacheDelete$2$1$1;
ListCache$2$1$1.prototype.get = listCacheGet$2$1$1;
ListCache$2$1$1.prototype.has = listCacheHas$2$1$1;
ListCache$2$1$1.prototype.set = listCacheSet$2$1$1;

/* Built-in method references that are verified to be native. */

var Map$1$1$1$1 = getNative$2$1$1(root$2$1$1, 'Map');
...
function mapCacheClear$2$1$1() {
  this.size = 0;
  this.__data__ = {
    'hash': new Hash$2$1$1(),
    'map': new (Map$1$1$1$1 || ListCache$2$1$1)(),
    'string': new Hash$2$1$1()
  };
}
 ...
 * @returns {boolean} Returns `true` if `value` is suitable, else `false`.
 */
function isKeyable$2$1$1(value) {
  var type = typeof value;
  return type == 'string' || type == 'number' || type == 'symbol' || type == 'boolean' ? value !== '__proto__' : value === null;
}
...
function getMapData$2$1$1(map, key) {
  var data = map.__data__;
  return isKeyable$2$1$1(key) ? data[typeof key == 'string' ? 'string' : 'hash'] : data.map;
}
...
function mapCacheDelete$2$1$1(key) {
  var result = getMapData$2$1$1(this, key)['delete'](key);
  this.size -= result ? 1 : 0;
  return result;
}
...
function mapCacheGet$2$1$1(key) {
  return getMapData$2$1$1(this, key).get(key);
}
...
function mapCacheHas$2$1$1(key) {
  return getMapData$2$1$1(this, key).has(key);
}
...
function mapCacheSet$2$1$1(key, value) {
  var data = getMapData$2$1$1(this, key),
      size = data.size;
  data.set(key, value);
  this.size += data.size == size ? 0 : 1;
  return this;
...
function MapCache$2$1$1(entries) {
  var index = -1,
      length = entries == null ? 0 : entries.length;
  this.clear();
...
MapCache$2$1$1.prototype.clear = mapCacheClear$2$1$1;
MapCache$2$1$1.prototype['delete'] = mapCacheDelete$2$1$1;
MapCache$2$1$1.prototype.get = mapCacheGet$2$1$1;
MapCache$2$1$1.prototype.has = mapCacheHas$2$1$1;
MapCache$2$1$1.prototype.set = mapCacheSet$2$1$1;

/** Error message constants. */

var FUNC_ERROR_TEXT$2$1$1 = 'Expected a function';
/**
 * Creates a function that memoizes the result of `func`. If `resolver` is
 * provided, it determines the cache key for storing the result based on the
 * arguments provided to the memoized function. By default, the first argument
...
function memoize$2$1$1(func, resolver) {
  if (typeof func != 'function' || resolver != null && typeof resolver != 'function') {
    throw new TypeError(FUNC_ERROR_TEXT$2$1$1);
  }
  ...
  memoized.cache = new (memoize$2$1$1.Cache || MapCache$2$1$1)();
  return memoized;
} // Expose `MapCache`.


memoize$2$1$1.Cache = MapCache$2$1$1;

/** Used as the maximum memoize cache size. */

var MAX_MEMOIZE_SIZE$2$1$1 = 500;
/**
 * A specialized version of `_.memoize` which clears the memoized function's
 * cache when it exceeds `MAX_MEMOIZE_SIZE`.
 *
...
function memoizeCapped$2$1$1(func) {
  var result = memoize$2$1$1(func, function (key) {
    if (cache.size === MAX_MEMOIZE_SIZE$2$1$1) {
      cache.clear();
    }
...
var rePropName$2$1$1 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g;
/** Used to match backslashes in property paths. */

var reEscapeChar$2$1$1 = /\\(\\)?/g;
/**
 * Converts `string` to a property path array.
 *
 * @private
...
var stringToPath$2$1$1 = memoizeCapped$2$1$1(function (string) {
  var result = [];
  ...
  string.replace(rePropName$2$1$1, function (match, number, quote, subString) {
    result.push(quote ? subString.replace(reEscapeChar$2$1$1, '$1') : number || match);
  });
  return result;
});
...
function toString$2$1$1(value) {
  return value == null ? '' : baseToString$2$1$1(value);
}
...
function castPath$2$1$1(value, object) {
  if (isArray$2$1$1(value)) {
    return value;
  }

  return isKey$2$1$1(value, object) ? [value] : stringToPath$2$1$1(toString$2$1$1(value));
}

/** Used as references for various `Number` constants. */

var INFINITY$1$2$1$1 = 1 / 0;
/**
 * Converts `value` to a string key if it's not a string or symbol.
 *
 * @private
...
function toKey$2$1$1(value) {
  if (typeof value == 'string' || isSymbol$2$1$1(value)) {
    return value;
  }

  var result = value + '';
  return result == '0' && 1 / value == -INFINITY$1$2$1$1 ? '-0' : result;
}
...
function baseGet$2$1$1(object, path) {
  path = castPath$2$1$1(path, object);
  var index = 0,
      length = path.length;

  while (object != null && index < length) {
    object = object[toKey$2$1$1(path[index++])];
  }
...
function get$2$1$1(object, path, defaultValue) {
  var result = object == null ? undefined : baseGet$2$1$1(object, path);
  return result === undefined ? defaultValue : result;
}
 ...
 * @returns {Array} Returns `array`.
 */
function arrayPush$1$1$1(array, values) {
  var index = -1,
      length = values.length,
      offset = array.length;
...
var spreadableSymbol$1$1$1 = Symbol$2$1$1 ? Symbol$2$1$1.isConcatSpreadable : undefined;
/**
 * Checks if `value` is a flattenable `arguments` object or array.
 *
 * @private
...
function isFlattenable$1$1$1(value) {
  return isArray$2$1$1(value) || isArguments$1$1$1(value) || !!(spreadableSymbol$1$1$1 && value && value[spreadableSymbol$1$1$1]);
}
...
function baseFlatten$1$1$1(array, depth, predicate, isStrict, result) {
  var index = -1,
      length = array.length;
  predicate || (predicate = isFlattenable$1$1$1);
  result || (result = []);
  ...
  while (++index < length) {
    ...
    if (depth > 0 && predicate(value)) {
      if (depth > 1) {
        // Recursively flatten arrays (susceptible to call stack limits).
        baseFlatten$1$1$1(value, depth - 1, predicate, isStrict, result);
      } else {
        arrayPush$1$1$1(result, value);
      }
    } else if (!isStrict) {
      result[result.length] = value;
    }
...
function flatten$1$1$1(array) {
  var length = array == null ? 0 : array.length;
  return length ? baseFlatten$1$1$1(array, 1) : [];
}
...
function flatRest$1$1$1(func) {
  return setToString$1$1$1(overRest$1$1$1(func, undefined, flatten$1$1$1), func + '');
}

/** Built-in value references. */

var getPrototype$1$1$1 = overArg$1$1$1(Object.getPrototypeOf, Object);

/** `Object#toString` result references. */

var objectTag$1$1$1$1 = '[object Object]';
/** Used for built-in method references. */

var funcProto$2$1$1$1 = Function.prototype,
    objectProto$b$1$1$1 = Object.prototype;
/** Used to resolve the decompiled source of functions. */

var funcToString$2$1$1$1 = funcProto$2$1$1$1.toString;
/** Used to check objects for own properties. */

var hasOwnProperty$9$1$1$1 = objectProto$b$1$1$1.hasOwnProperty;
/** Used to infer the `Object` constructor. */

var objectCtorString$1$1$1 = funcToString$2$1$1$1.call(Object);
/**
 * Checks if `value` is a plain object, that is, an object created by the
 * `Object` constructor or one with a `[[Prototype]]` of `null`.
 *
...
function isPlainObject$1$1$1(value) {
  if (!isObjectLike$2$1$1(value) || baseGetTag$2$1$1(value) != objectTag$1$1$1$1) {
    return false;
  }

  var proto = getPrototype$1$1$1(value);

  if (proto === null) {
    return true;
  }

  var Ctor = hasOwnProperty$9$1$1$1.call(proto, 'constructor') && proto.constructor;
  return typeof Ctor == 'function' && Ctor instanceof Ctor && funcToString$2$1$1$1.call(Ctor) == objectCtorString$1$1$1;
}

/** `Object#toString` result references. */

var domExcTag$1$1$1 = '[object DOMException]',
    errorTag$1$1$1$1 = '[object Error]';
/**
 * Checks if `value` is an `Error`, `EvalError`, `RangeError`, `ReferenceError`,
 * `SyntaxError`, `TypeError`, or `URIError` object.
 *
...
function isError$1$1$1(value) {
  if (!isObjectLike$2$1$1(value)) {
    return false;
  }

  var tag = baseGetTag$2$1$1(value);
  return tag == errorTag$1$1$1$1 || tag == domExcTag$1$1$1 || typeof value.message == 'string' && typeof value.name == 'string' && !isPlainObject$1$1$1(value);
}
...
var attempt$1$1$1 = baseRest$1$1$1(function (func, args) {
  try {
    return apply$1$1$1(func, undefined, args);
  } catch (e) {
    return isError$1$1$1(e) ? e : new Error(e);
  }
});
 ...
 * @returns {Array} Returns the slice of `array`.
 */
function baseSlice$1$1$1(array, start, end) {
  var index = -1,
      length = array.length;
 ...
 * @returns {Function} Returns the new accessor function.
 */
function basePropertyOf$1$1$1(object) {
  return function (key) {
    return object == null ? undefined : object[key];
  };
}
...
function stackClear$1$1$1() {
  this.__data__ = new ListCache$2$1$1();
  this.size = 0;
}
 ...
 * @returns {boolean} Returns `true` if the entry was removed, else `false`.
 */
function stackDelete$1$1$1(key) {
  var data = this.__data__,
      result = data['delete'](key);
  this.size = data.size;
  return result;
 ...
 * @returns {boolean} Returns `true` if an entry for `key` exists, else `false`.
 */
function stackHas$1$1$1(key) {
  return this.__data__.has(key);
}

/** Used as the size to enable large array optimizations. */

var LARGE_ARRAY_SIZE$1$1$1 = 200;
/**
 * Sets the stack `key` to `value`.
 *
 * @private
...
function stackSet$1$1$1(key, value) {
  var data = this.__data__;

  if (data instanceof ListCache$2$1$1) {
    var pairs = data.__data__;

    if (!Map$1$1$1$1 || pairs.length < LARGE_ARRAY_SIZE$1$1$1 - 1) {
      pairs.push([key, value]);
      this.size = ++data.size;
      return this;
    }

    data = this.__data__ = new MapCache$2$1$1(pairs);
  }
...
function Stack$1$1$1(entries) {
  var data = this.__data__ = new ListCache$2$1$1(entries);
  this.size = data.size;
} // Add methods to `Stack`.


Stack$1$1$1.prototype.clear = stackClear$1$1$1;
Stack$1$1$1.prototype['delete'] = stackDelete$1$1$1;
Stack$1$1$1.prototype.get = stackGet$1$1$1;
Stack$1$1$1.prototype.has = stackHas$1$1$1;
Stack$1$1$1.prototype.set = stackSet$1$1$1;
...
function baseAssign$1$1$1(object, source) {
  return object && copyObject$1$1$1(source, keys$1$1$1(source), object);
}
...
function baseAssignIn$1$1$1(object, source) {
  return object && copyObject$1$1$1(source, keysIn$1$1$1$1(source), object);
}

/** Detect free variable `exports`. */

var freeExports$2$1$1$1 = typeof exports == 'object' && exports && !exports.nodeType && exports;
/** Detect free variable `module`. */

var freeModule$2$1$1$1 = freeExports$2$1$1$1 && typeof module == 'object' && module && !module.nodeType && module;
/** Detect the popular CommonJS extension `module.exports`. */

var moduleExports$2$1$1$1 = freeModule$2$1$1$1 && freeModule$2$1$1$1.exports === freeExports$2$1$1$1;
/** Built-in value references. */

var Buffer$1$1$1$1 = moduleExports$2$1$1$1 ? root$2$1$1.Buffer : undefined,
    allocUnsafe$1$1$1 = Buffer$1$1$1$1 ? Buffer$1$1$1$1.allocUnsafe : undefined;
/**
 * Creates a clone of  `buffer`.
 *
 * @private
...
function cloneBuffer$1$1$1(buffer, isDeep) {
  if (isDeep) {
    return buffer.slice();
  }

  var length = buffer.length,
      result = allocUnsafe$1$1$1 ? allocUnsafe$1$1$1(length) : new buffer.constructor(length);
  buffer.copy(result);
  return result;
}
 ...
 * @returns {Array} Returns the new filtered array.
 */
function arrayFilter$1$1$1(array, predicate) {
  var index = -1,
      length = array == null ? 0 : array.length,
      resIndex = 0,
      result = [];
 ...
 * // => false
 */
function stubArray$1$1$1() {
  return [];
}

/** Used for built-in method references. */

var objectProto$c$1$1$1 = Object.prototype;
/** Built-in value references. */

var propertyIsEnumerable$1$1$1$1 = objectProto$c$1$1$1.propertyIsEnumerable;
/* Built-in method references for those with the same name as other `lodash` methods. */

var nativeGetSymbols$2$1$1 = Object.getOwnPropertySymbols;
/**
 * Creates an array of the own enumerable symbols of `object`.
 *
 * @private
...
var getSymbols$1$1$1 = !nativeGetSymbols$2$1$1 ? stubArray$1$1$1 : function (object) {
  if (object == null) {
    return [];
  }

  object = Object(object);
  return arrayFilter$1$1$1(nativeGetSymbols$2$1$1(object), function (symbol) {
    return propertyIsEnumerable$1$1$1$1.call(object, symbol);
  });
};
...
function copySymbols$1$1$1(source, object) {
  return copyObject$1$1$1(source, getSymbols$1$1$1(source), object);
}

/* Built-in method references for those with the same name as other `lodash` methods. */

var nativeGetSymbols$1$1$1$1 = Object.getOwnPropertySymbols;
/**
 * Creates an array of the own and inherited enumerable symbols of `object`.
 *
 * @private
...
var getSymbolsIn$1$1$1 = !nativeGetSymbols$1$1$1$1 ? stubArray$1$1$1 : function (object) {
  var result = [];

  while (object) {
    arrayPush$1$1$1(result, getSymbols$1$1$1(object));
    object = getPrototype$1$1$1(object);
  }
...
function copySymbolsIn$1$1$1(source, object) {
  return copyObject$1$1$1(source, getSymbolsIn$1$1$1(source), object);
}
...
function baseGetAllKeys$1$1$1(object, keysFunc, symbolsFunc) {
  var result = keysFunc(object);
  return isArray$2$1$1(object) ? result : arrayPush$1$1$1(result, symbolsFunc(object));
}
...
function getAllKeys$1$1$1(object) {
  return baseGetAllKeys$1$1$1(object, keys$1$1$1, getSymbols$1$1$1);
}
...
function getAllKeysIn$1$1$1(object) {
  return baseGetAllKeys$1$1$1(object, keysIn$1$1$1$1, getSymbolsIn$1$1$1);
}

/* Built-in method references that are verified to be native. */

var DataView$1$1$1 = getNative$2$1$1(root$2$1$1, 'DataView');

/* Built-in method references that are verified to be native. */

var Promise$1$1$1$1 = getNative$2$1$1(root$2$1$1, 'Promise');

/* Built-in method references that are verified to be native. */

var Set$1$1$1 = getNative$2$1$1(root$2$1$1, 'Set');

/** `Object#toString` result references. */

var mapTag$1$1$1$1 = '[object Map]',
    objectTag$2$1$1$1 = '[object Object]',
    promiseTag$1$1$1 = '[object Promise]',
    setTag$1$1$1$1 = '[object Set]',
    weakMapTag$1$1$1$1 = '[object WeakMap]';
var dataViewTag$1$1$1$1 = '[object DataView]';
/** Used to detect maps, sets, and weakmaps. */

var dataViewCtorString$1$1$1 = toSource$2$1$1(DataView$1$1$1),
    mapCtorString$1$1$1 = toSource$2$1$1(Map$1$1$1$1),
    promiseCtorString$1$1$1 = toSource$2$1$1(Promise$1$1$1$1),
    setCtorString$1$1$1 = toSource$2$1$1(Set$1$1$1),
    weakMapCtorString$1$1$1 = toSource$2$1$1(WeakMap$1$1$1$1);
/**
 * Gets the `toStringTag` of `value`.
 *
 * @private
...
var getTag$2$1$1 = baseGetTag$2$1$1; // Fallback for data views, maps, sets, and weak maps in IE 11 and promises in Node.js < 6.

if (DataView$1$1$1 && getTag$2$1$1(new DataView$1$1$1(new ArrayBuffer(1))) != dataViewTag$1$1$1$1 || Map$1$1$1$1 && getTag$2$1$1(new Map$1$1$1$1()) != mapTag$1$1$1$1 || Promise$1$1$1$1 && getTag$2$1$1(Promise$1$1$1$1.resolve()) != promiseTag$1$1$1 || Set$1$1$1 && getTag$2$1$1(new Set$1$1$1()) != setTag$1$1$1$1 || WeakMap$1$1$1$1 && getTag$2$1$1(new WeakMap$1$1$1$1()) != weakMapTag$1$1$1$1) {
  getTag$2$1$1 = function (value) {
    var result = baseGetTag$2$1$1(value),
        Ctor = result == objectTag$2$1$1$1 ? value.constructor : undefined,
        ctorString = Ctor ? toSource$2$1$1(Ctor) : '';

    if (ctorString) {
      switch (ctorString) {
        case dataViewCtorString$1$1$1:
          return dataViewTag$1$1$1$1;

        case mapCtorString$1$1$1:
          return mapTag$1$1$1$1;

        case promiseCtorString$1$1$1:
          return promiseTag$1$1$1;

        case setCtorString$1$1$1:
          return setTag$1$1$1$1;

        case weakMapCtorString$1$1$1:
          return weakMapTag$1$1$1$1;
      }
    }
...
var getTag$1$1$1$1 = getTag$2$1$1;

/** Used for built-in method references. */
var objectProto$d$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$a$1$1$1 = objectProto$d$1$1$1.hasOwnProperty;
/**
 * Initializes an array clone.
 *
 * @private
...
function initCloneArray$1$1$1(array) {
  var length = array.length,
      result = new array.constructor(length); // Add properties assigned by `RegExp#exec`.

  if (length && typeof array[0] == 'string' && hasOwnProperty$a$1$1$1.call(array, 'index')) {
    result.index = array.index;
    result.input = array.input;
  }
...
var Uint8Array$1$1$1 = root$2$1$1.Uint8Array;
...
function cloneArrayBuffer$1$1$1(arrayBuffer) {
  var result = new arrayBuffer.constructor(arrayBuffer.byteLength);
  new Uint8Array$1$1$1(result).set(new Uint8Array$1$1$1(arrayBuffer));
  return result;
}
...
function cloneDataView$1$1$1(dataView, isDeep) {
  var buffer = isDeep ? cloneArrayBuffer$1$1$1(dataView.buffer) : dataView.buffer;
  return new dataView.constructor(buffer, dataView.byteOffset, dataView.byteLength);
}
...
function cloneRegExp$1$1$1(regexp) {
  var result = new regexp.constructor(regexp.source, reFlags$1$1$1.exec(regexp));
  result.lastIndex = regexp.lastIndex;
  return result;
}
...
var symbolProto$1$1$1$1 = Symbol$2$1$1 ? Symbol$2$1$1.prototype : undefined,
    symbolValueOf$1$1$1 = symbolProto$1$1$1$1 ? symbolProto$1$1$1$1.valueOf : undefined;
/**
 * Creates a clone of the `symbol` object.
 *
 * @private
...
function cloneSymbol$1$1$1(symbol) {
  return symbolValueOf$1$1$1 ? Object(symbolValueOf$1$1$1.call(symbol)) : {};
}
...
function cloneTypedArray$1$1$1(typedArray, isDeep) {
  var buffer = isDeep ? cloneArrayBuffer$1$1$1(typedArray.buffer) : typedArray.buffer;
  return new typedArray.constructor(buffer, typedArray.byteOffset, typedArray.length);
}

/** `Object#toString` result references. */

var boolTag$1$1$1$1 = '[object Boolean]',
    dateTag$1$1$1$1 = '[object Date]',
    mapTag$2$1$1$1 = '[object Map]',
    numberTag$1$1$1$1 = '[object Number]',
    regexpTag$1$1$1$1 = '[object RegExp]',
    setTag$2$1$1$1 = '[object Set]',
    stringTag$1$1$1$1 = '[object String]',
    symbolTag$1$1$1$1 = '[object Symbol]';
var arrayBufferTag$1$1$1$1 = '[object ArrayBuffer]',
    dataViewTag$2$1$1$1 = '[object DataView]',
    float32Tag$1$1$1$1 = '[object Float32Array]',
    float64Tag$1$1$1$1 = '[object Float64Array]',
    int8Tag$1$1$1$1 = '[object Int8Array]',
    int16Tag$1$1$1$1 = '[object Int16Array]',
    int32Tag$1$1$1$1 = '[object Int32Array]',
    uint8Tag$1$1$1$1 = '[object Uint8Array]',
    uint8ClampedTag$1$1$1$1 = '[object Uint8ClampedArray]',
    uint16Tag$1$1$1$1 = '[object Uint16Array]',
    uint32Tag$1$1$1$1 = '[object Uint32Array]';
/**
 * Initializes an object clone based on its `toStringTag`.
 *
 * **Note:** This function only supports cloning values with tags of
...
function initCloneByTag$1$1$1(object, tag, isDeep) {
  var Ctor = object.constructor;

  switch (tag) {
    case arrayBufferTag$1$1$1$1:
      return cloneArrayBuffer$1$1$1(object);

    case boolTag$1$1$1$1:
    case dateTag$1$1$1$1:
      return new Ctor(+object);

    case dataViewTag$2$1$1$1:
      return cloneDataView$1$1$1(object, isDeep);

    case float32Tag$1$1$1$1:
    case float64Tag$1$1$1$1:
    case int8Tag$1$1$1$1:
    case int16Tag$1$1$1$1:
    case int32Tag$1$1$1$1:
    case uint8Tag$1$1$1$1:
    case uint8ClampedTag$1$1$1$1:
    case uint16Tag$1$1$1$1:
    case uint32Tag$1$1$1$1:
      return cloneTypedArray$1$1$1(object, isDeep);

    case mapTag$2$1$1$1:
      return new Ctor();

    case numberTag$1$1$1$1:
    case stringTag$1$1$1$1:
      return new Ctor(object);

    case regexpTag$1$1$1$1:
      return cloneRegExp$1$1$1(object);

    case setTag$2$1$1$1:
      return new Ctor();

    case symbolTag$1$1$1$1:
      return cloneSymbol$1$1$1(object);
  }
}
...
function initCloneObject$1$1$1(object) {
  return typeof object.constructor == 'function' && !isPrototype$1$1$1(object) ? baseCreate$1$1$1(getPrototype$1$1$1(object)) : {};
}

/** `Object#toString` result references. */

var mapTag$3$1$1$1 = '[object Map]';
/**
 * The base implementation of `_.isMap` without Node.js optimizations.
 *
 * @private
...
function baseIsMap$1$1$1(value) {
  return isObjectLike$2$1$1(value) && getTag$1$1$1$1(value) == mapTag$3$1$1$1;
}

/* Node.js helper references. */

var nodeIsMap$1$1$1 = nodeUtil$1$1$1 && nodeUtil$1$1$1.isMap;
/**
 * Checks if `value` is classified as a `Map` object.
 *
 * @static
...
var isMap$1$1$1 = nodeIsMap$1$1$1 ? baseUnary$1$1$1(nodeIsMap$1$1$1) : baseIsMap$1$1$1;

/** `Object#toString` result references. */

var setTag$3$1$1$1 = '[object Set]';
/**
 * The base implementation of `_.isSet` without Node.js optimizations.
 *
 * @private
...
function baseIsSet$1$1$1(value) {
  return isObjectLike$2$1$1(value) && getTag$1$1$1$1(value) == setTag$3$1$1$1;
}

/* Node.js helper references. */

var nodeIsSet$1$1$1 = nodeUtil$1$1$1 && nodeUtil$1$1$1.isSet;
/**
 * Checks if `value` is classified as a `Set` object.
 *
 * @static
...
var isSet$1$1$1 = nodeIsSet$1$1$1 ? baseUnary$1$1$1(nodeIsSet$1$1$1) : baseIsSet$1$1$1;

/** Used to compose bitmasks for cloning. */

var CLONE_DEEP_FLAG$2$1$1 = 1,
    CLONE_FLAT_FLAG$2$1$1 = 2,
    CLONE_SYMBOLS_FLAG$2$1$1 = 4;
/** `Object#toString` result references. */

var argsTag$2$1$1$1 = '[object Arguments]',
    arrayTag$1$1$1$1 = '[object Array]',
    boolTag$2$1$1$1 = '[object Boolean]',
    dateTag$2$1$1$1 = '[object Date]',
    errorTag$2$1$1$1 = '[object Error]',
    funcTag$2$1$1$1 = '[object Function]',
    genTag$1$1$1$1 = '[object GeneratorFunction]',
    mapTag$4$1$1$1 = '[object Map]',
    numberTag$2$1$1$1 = '[object Number]',
    objectTag$3$1$1$1 = '[object Object]',
    regexpTag$2$1$1$1 = '[object RegExp]',
    setTag$4$1$1$1 = '[object Set]',
    stringTag$2$1$1$1 = '[object String]',
    symbolTag$2$1$1$1 = '[object Symbol]',
    weakMapTag$2$1$1$1 = '[object WeakMap]';
var arrayBufferTag$2$1$1$1 = '[object ArrayBuffer]',
    dataViewTag$3$1$1$1 = '[object DataView]',
    float32Tag$2$1$1$1 = '[object Float32Array]',
    float64Tag$2$1$1$1 = '[object Float64Array]',
    int8Tag$2$1$1$1 = '[object Int8Array]',
    int16Tag$2$1$1$1 = '[object Int16Array]',
    int32Tag$2$1$1$1 = '[object Int32Array]',
    uint8Tag$2$1$1$1 = '[object Uint8Array]',
    uint8ClampedTag$2$1$1$1 = '[object Uint8ClampedArray]',
    uint16Tag$2$1$1$1 = '[object Uint16Array]',
    uint32Tag$2$1$1$1 = '[object Uint32Array]';
/** Used to identify `toStringTag` values supported by `_.clone`. */

var cloneableTags$1$1$1 = {};
cloneableTags$1$1$1[argsTag$2$1$1$1] = cloneableTags$1$1$1[arrayTag$1$1$1$1] = cloneableTags$1$1$1[arrayBufferTag$2$1$1$1] = cloneableTags$1$1$1[dataViewTag$3$1$1$1] = cloneableTags$1$1$1[boolTag$2$1$1$1] = cloneableTags$1$1$1[dateTag$2$1$1$1] = cloneableTags$1$1$1[float32Tag$2$1$1$1] = cloneableTags$1$1$1[float64Tag$2$1$1$1] = cloneableTags$1$1$1[int8Tag$2$1$1$1] = cloneableTags$1$1$1[int16Tag$2$1$1$1] = cloneableTags$1$1$1[int32Tag$2$1$1$1] = cloneableTags$1$1$1[mapTag$4$1$1$1] = cloneableTags$1$1$1[numberTag$2$1$1$1] = cloneableTags$1$1$1[objectTag$3$1$1$1] = cloneableTags$1$1$1[regexpTag$2$1$1$1] = cloneableTags$1$1$1[setTag$4$1$1$1] = cloneableTags$1$1$1[stringTag$2$1$1$1] = cloneableTags$1$1$1[symbolTag$2$1$1$1] = cloneableTags$1$1$1[uint8Tag$2$1$1$1] = cloneableTags$1$1$1[uint8ClampedTag$2$1$1$1] = cloneableTags$1$1$1[uint16Tag$2$1$1$1] = cloneableTags$1$1$1[uint32Tag$2$1$1$1] = true;
cloneableTags$1$1$1[errorTag$2$1$1$1] = cloneableTags$1$1$1[funcTag$2$1$1$1] = cloneableTags$1$1$1[weakMapTag$2$1$1$1] = false;
/**
 * The base implementation of `_.clone` and `_.cloneDeep` which tracks
 * traversed objects.
 *
...
function baseClone$1$1$1(value, bitmask, customizer, key, object, stack) {
  var result,
      isDeep = bitmask & CLONE_DEEP_FLAG$2$1$1,
      isFlat = bitmask & CLONE_FLAT_FLAG$2$1$1,
      isFull = bitmask & CLONE_SYMBOLS_FLAG$2$1$1;
  ...
  if (isArr) {
    result = initCloneArray$1$1$1(value);

    if (!isDeep) {
      return copyArray$1$1$1(value, result);
    }
  } else {
    var tag = getTag$1$1$1$1(value),
        isFunc = tag == funcTag$2$1$1$1 || tag == genTag$1$1$1$1;

    if (isBuffer$1$1$1(value)) {
      return cloneBuffer$1$1$1(value, isDeep);
    }

    if (tag == objectTag$3$1$1$1 || tag == argsTag$2$1$1$1 || isFunc && !object) {
      result = isFlat || isFunc ? {} : initCloneObject$1$1$1(value);

      if (!isDeep) {
        return isFlat ? copySymbolsIn$1$1$1(value, baseAssignIn$1$1$1(result, value)) : copySymbols$1$1$1(value, baseAssign$1$1$1(result, value));
      }
    } else {
      if (!cloneableTags$1$1$1[tag]) {
        return object ? value : {};
      }

      result = initCloneByTag$1$1$1(value, tag, isDeep);
    }
  } // Check for circular references and return its corresponding clone.


  stack || (stack = new Stack$1$1$1());
  var stacked = stack.get(value);
  ...
  if (isSet$1$1$1(value)) {
    value.forEach(function (subValue) {
      result.add(baseClone$1$1$1(subValue, bitmask, customizer, subValue, value, stack));
    });
  } else if (isMap$1$1$1(value)) {
    value.forEach(function (subValue, key) {
      result.set(key, baseClone$1$1$1(subValue, bitmask, customizer, key, value, stack));
    });
  }

  var keysFunc = isFull ? isFlat ? getAllKeysIn$1$1$1 : getAllKeys$1$1$1 : isFlat ? keysIn : keys$1$1$1;
  var props = isArr ? undefined : keysFunc(value);
  arrayEach$1$1$1(props || value, function (subValue, key) {
    if (props) {
      key = subValue;
      subValue = value[key];
    } // Recursively populate clone (susceptible to call stack limits).
    ...
    assignValue$1$1$1(result, key, baseClone$1$1$1(subValue, bitmask, customizer, key, value, stack));
  });
  return result;
}
...
var escapeHtmlChar$1$1$1 = basePropertyOf$1$1$1(htmlEscapes$1$1$1);

/** Used to match HTML entities and HTML characters. */

var reUnescapedHtml$1$1$1 = /[&<>"']/g,
    reHasUnescapedHtml$1$1$1 = RegExp(reUnescapedHtml$1$1$1.source);
/**
 * Converts the characters "&", "<", ">", '"', and "'" in `string` to their
 * corresponding HTML entities.
 *
...
function escape$1$1$1(string) {
  string = toString$2$1$1(string);
  return string && reHasUnescapedHtml$1$1$1.test(string) ? string.replace(reUnescapedHtml$1$1$1, escapeHtmlChar$1$1$1) : string;
}

/** `Object#toString` result references. */

var stringTag$3$1$1$1 = '[object String]';
/**
 * Checks if `value` is classified as a `String` primitive or object.
 *
 * @static
...
function isString$1$1$1(value) {
  return typeof value == 'string' || !isArray$2$1$1(value) && isObjectLike$2$1$1(value) && baseGetTag$2$1$1(value) == stringTag$3$1$1$1;
}
...
function baseValues$1$1$1(object, props) {
  return arrayMap$2$1$1(props, function (key) {
    return object[key];
  });
}
...
function parent$1$1$1(object, path) {
  return path.length < 2 ? object : baseGet$2$1$1(object, baseSlice$1$1$1(path, 0, -1));
}
...
function baseUnset$1$1$1(object, path) {
  path = castPath$2$1$1(path, object);
  object = parent$1$1$1(object, path);
  return object == null || delete object[toKey$2$1$1(last$2$1$1(path))];
}
...
function customOmitClone$1$1$1(value) {
  return isPlainObject$1$1$1(value) ? undefined : value;
}

/** Used to compose bitmasks for cloning. */

var CLONE_DEEP_FLAG$1$1$1$1 = 1,
    CLONE_FLAT_FLAG$1$1$1$1 = 2,
    CLONE_SYMBOLS_FLAG$1$1$1$1 = 4;
/**
 * The opposite of `_.pick`; this method creates an object composed of the
 * own and inherited enumerable property paths of `object` that are not omitted.
 *
...
var omit$1$1$1 = flatRest$1$1$1(function (object, paths) {
  var result = {};
  ...
  var isDeep = false;
  paths = arrayMap$2$1$1(paths, function (path) {
    path = castPath$2$1$1(path, object);
    isDeep || (isDeep = path.length > 1);
    return path;
  });
  copyObject$1$1$1(object, getAllKeysIn$1$1$1(object), result);

  if (isDeep) {
    result = baseClone$1$1$1(result, CLONE_DEEP_FLAG$1$1$1$1 | CLONE_FLAT_FLAG$1$1$1$1 | CLONE_SYMBOLS_FLAG$1$1$1$1, customOmitClone$1$1$1);
  }

  var length = paths.length;

  while (length--) {
    baseUnset$1$1$1(result, paths[length]);
  }
...
var objectProto$e$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$b$1$1$1 = objectProto$e$1$1$1.hasOwnProperty;
/**
 * Used by `_.defaults` to customize its `_.assignIn` use to assign properties
 * of source objects to the destination object for all destination properties
 * that resolve to `undefined`.
...
function customDefaultsAssignIn$1$1$1(objValue, srcValue, key, object) {
  if (objValue === undefined || eq$2$1$1(objValue, objectProto$e$1$1$1[key]) && !hasOwnProperty$b$1$1$1.call(object, key)) {
    return srcValue;
  }
...
function escapeStringChar$1$1$1(chr) {
  return '\\' + stringEscapes$1$1$1[chr];
}

/** Used to match template delimiters. */
var reInterpolate$1$1$1 = /<%=([\s\S]+?)%>/g;

/** Used to match template delimiters. */
var reEscape$1$1$1 = /<%-([\s\S]+?)%>/g;

/** Used to match template delimiters. */
var reEvaluate$1$1$1 = /<%([\s\S]+?)%>/g;
...
var templateSettings$1$1$1 = {
   ...
   * @type {RegExp}
   */
  'interpolate': reInterpolate$1$1$1,
...
var reEmptyStringLeading$1$1$1 = /\b__p \+= '';/g,
    reEmptyStringMiddle$1$1$1 = /\b(__p \+=) '' \+/g,
    reEmptyStringTrailing$1$1$1 = /(__e\(.*?\)|\b__t\)) \+\n'';/g;
/**
 * Used to match
 * [ES template delimiters](http://ecma-international.org/ecma-262/7.0/#sec-template-literal-lexical-components).
 */

var reEsTemplate$1$1$1 = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g;
/** Used to ensure capturing order of template delimiters. */

var reNoMatch$1$1$1 = /($^)/;
/** Used to match unescaped characters in compiled string literals. */

var reUnescapedString$1$1$1 = /['\n\r\u2028\u2029\\]/g;
/** Used for built-in method references. */

var objectProto$f$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$c$1$1$1 = objectProto$f$1$1$1.hasOwnProperty;
/**
 * Creates a compiled template function that can interpolate data properties
 * in "interpolate" delimiters, HTML-escape interpolated data properties in
 * "escape" delimiters, and execute JavaScript in "evaluate" delimiters. Data
...
function template$1$1$1(string, options, guard) {
  // Based on John Resig's `tmpl` implementation
  // (http://ejohn.org/blog/javascript-micro-templating/)
  // and Laura Doktorova's doT.js (https://github.com/olado/doT).
  var settings = templateSettings$1$1$1.imports._.templateSettings || templateSettings$1$1$1;

  if (guard && isIterateeCall$1$1$1(string, options, guard)) {
    options = undefined;
  }

  string = toString$2$1$1(string);
  options = assignInWith$1$1$1({}, options, settings, customDefaultsAssignIn$1$1$1);
  var imports = assignInWith$1$1$1({}, options.imports, settings.imports, customDefaultsAssignIn$1$1$1),
      importsKeys = keys$1$1$1(imports),
      importsValues = baseValues$1$1$1(imports, importsKeys);
  var isEscaping,
      isEvaluating,
      index = 0,
      interpolate = options.interpolate || reNoMatch$1$1$1,
      source = "__p += '"; // Compile the regexp to match each delimiter.

  var reDelimiters = RegExp((options.escape || reNoMatch$1$1$1).source + '|' + interpolate.source + '|' + (interpolate === reInterpolate$1$1$1 ? reEsTemplate$1$1$1 : reNoMatch$1$1$1).source + '|' + (options.evaluate || reNoMatch$1$1$1).source + '|$', 'g'); // Use a sourceURL for easier debugging.
  // The sourceURL gets injected into the source that's eval-ed, so be careful
  // with lookup (in case of e.g. prototype pollution), and strip newlines if any.
  // A newline wouldn't be a valid sourceURL anyway, and it'd enable code injection.

  var sourceURL = hasOwnProperty$c$1$1$1.call(options, 'sourceURL') ? '//# sourceURL=' + (options.sourceURL + '').replace(/[\r\n]/g, ' ') + '\n' : '';
  string.replace(reDelimiters, function (match, escapeValue, interpolateValue, esTemplateValue, evaluateValue, offset) {
    interpolateValue || (interpolateValue = esTemplateValue); // Escape characters that can't be included in string literals.

    source += string.slice(index, offset).replace(reUnescapedString$1$1$1, escapeStringChar$1$1$1); // Replace delimiters with snippets.
  ...
  var variable = hasOwnProperty$c$1$1$1.call(options, 'variable') && options.variable;
  ...
  source = (isEvaluating ? source.replace(reEmptyStringLeading$1$1$1, '') : source).replace(reEmptyStringMiddle$1$1$1, '$1').replace(reEmptyStringTrailing$1$1$1, '$1;'); // Frame code as the function body.

  source = 'function(' + (variable || 'obj') + ') {\n' + (variable ? '' : 'obj || (obj = {});\n') + "var __t, __p = ''" + (isEscaping ? ', __e = _.escape' : '') + (isEvaluating ? ', __j = Array.prototype.join;\n' + "function print() { __p += __j.call(arguments, '') }\n" : ';\n') + source + 'return __p\n}';
  var result = attempt$1$1$1(function () {
    return Function(importsKeys, sourceURL + 'return ' + source).apply(undefined, importsValues);
  }); // Provide the compiled function's source by its `toString` method or
  // the `source` property as a convenience for inlining compiled templates.
...
var isBrowser$1$1$1 = typeof window !== 'undefined' && typeof document !== 'undefined' && window.document === document; // Returns global object of a current environment.
...
var requestAnimationFrame$1$1$1$1 = function () {
  if (typeof requestAnimationFrame === 'function') {
    // It's required to use a bounded function because IE sometimes throws
    // an "Invalid calling object" error if rAF is invoked without the global
    // object on the left hand side.
...
function throttle$1$1$1(callback, delay) {
  var leadingCall = false,
      trailingCall = false,
      lastCallTime = 0;
  /**
  ...
  function timeoutCallback() {
    requestAnimationFrame$1$1$1$1(resolvePending);
  }
  /**
   * Schedules invocation of the original function.
   *
  ...
  function proxy() {
    ...
    if (leadingCall) {
      // Reject immediately following calls.
      if (timeStamp - lastCallTime < trailingTimeout$1$1$1) {
        return;
      } // Schedule new call to be in invoked when the pending one is resolved.
      // This is important for "transitions" which never actually start
      // immediately so there is a chance that we might miss one if change
...
var REFRESH_DELAY$1$1$1 = 20; // A list of substrings of CSS properties used to find transition events that
// might affect dimensions of observed elements.

var transitionKeys$1$1$1 = ['top', 'right', 'bottom', 'left', 'width', 'height', 'size', 'weight']; // Check if MutationObserver is available.

var mutationObserverSupported$1$1$1 = typeof MutationObserver !== 'undefined';
/**
 * Singleton controller class which handles updates of ResizeObserver instances.
 */

var ResizeObserverController$1$1$1 =
/** @class */
function () {
  /**
   * Creates a new instance of ResizeObserverController.
  ...
  function ResizeObserverController() {
    ...
    this.observers_ = [];
    this.onTransitionEnd_ = this.onTransitionEnd_.bind(this);
    this.refresh = throttle$1$1$1(this.refresh.bind(this), REFRESH_DELAY$1$1$1);
  }
  /**
   * Adds observer to observers list.
   *
  ...
  ResizeObserverController.prototype.connect_ = function () {
    // Do nothing if running in a non-browser environment or if listeners
    // have been already added.
    if (!isBrowser$1$1$1 || this.connected_) {
      return;
    } // Subscription to the "Transitionend" event is used as a workaround for
    // delayed transitions. This way it's possible to capture at least the
    // final state of an element.
    ...
    if (mutationObserverSupported$1$1$1) {
      this.mutationsObserver_ = new MutationObserver(this.refresh);
      this.mutationsObserver_.observe(document, {
        attributes: true,
        childList: true,
  ...
  ResizeObserverController.prototype.onTransitionEnd_ = function (_a) {
    ...
    var isReflowProperty = transitionKeys$1$1$1.some(function (key) {
      return !!~propertyName.indexOf(key);
    });
...
var defineConfigurable$1$1$1 = function (target, props) {
  for (var _i = 0, _a = Object.keys(props); _i < _a.length; _i++) {
    var key = _a[_i];
    Object.defineProperty(target, key, {
      value: props[key],
...
var getWindowOf$1$1$1 = function (target) {
  // Assume that the element is an instance of Node, which means that it
  // has the "ownerDocument" property from which we can retrieve a
  // corresponding global object.
  var ownerGlobal = target && target.ownerDocument && target.ownerDocument.defaultView; // Return the local global object if it's not possible extract one from
...
var emptyRect$1$1$1 = createRectInit$1$1$1(0, 0, 0, 0);
/**
 * Converts provided string to a number.
 *
 * @param {number|string} value
...
function getBordersSize$1$1$1(styles) {
  var positions = [];
  ...
  return positions.reduce(function (size, position) {
    var value = styles['border-' + position + '-width'];
    return size + toFloat$1$1$1(value);
  }, 0);
}
/**
 * Extracts paddings sizes from provided styles.
...
function getPaddings$1$1$1(styles) {
  var positions = ['top', 'right', 'bottom', 'left'];
  var paddings = {};
  ...
  for (var _i = 0, positions_1 = positions; _i < positions_1.length; _i++) {
    var position = positions_1[_i];
    var value = styles['padding-' + position];
    paddings[position] = toFloat$1$1$1(value);
  }
...
function getSVGContentRect$1$1$1(target) {
  var bbox = target.getBBox();
  return createRectInit$1$1$1(0, 0, bbox.width, bbox.height);
}
/**
 * Calculates content rectangle of provided HTMLElement.
 *
...
function getHTMLElementContentRect$1$1$1(target) {
  // Client width & height properties can't be
  // used exclusively as they provide rounded values.
  var clientWidth = target.clientWidth,
      clientHeight = target.clientHeight; // By this condition we can catch all non-replaced inline, hidden and
  ...
  if (!clientWidth && !clientHeight) {
    return emptyRect$1$1$1;
  }

  var styles = getWindowOf$1$1$1(target).getComputedStyle(target);
  var paddings = getPaddings$1$1$1(styles);
  var horizPad = paddings.left + paddings.right;
  var vertPad = paddings.top + paddings.bottom; // Computed styles of width & height are being used because they are the
  // only dimensions available to JS that contain non-rounded values. It could
  // be possible to utilize the getBoundingClientRect if only it's data wasn't
  ...
  var width = toFloat$1$1$1(styles.width),
      height = toFloat$1$1$1(styles.height); // Width & height include paddings and borders when the 'border-box' box
  // model is applied (except for IE).
  ...
  if (styles.boxSizing === 'border-box') {
    ...
    // anything, or an element merely doesn't have paddings/borders styles.
    if (Math.round(width + horizPad) !== clientWidth) {
      width -= getBordersSize$1$1$1(styles, 'left', 'right') + horizPad;
    }

    if (Math.round(height + vertPad) !== clientHeight) {
      height -= getBordersSize$1$1$1(styles, 'top', 'bottom') + vertPad;
    }
  } // Following steps can't be applied to the document's root element as its
  // client[Width/Height] properties represent viewport area of the window.
  // Besides, it's as well not necessary as the <html> itself neither has
  ...
  if (!isDocumentElement$1$1$1(target)) {
    // In some browsers (only in Firefox, actually) CSS width & height
    // include scroll bars size which can be removed at this step as scroll
    // bars are the only difference between rounded dimensions + paddings
    // and "client" properties, though that is not always true in Chrome.
  ...
  return createRectInit$1$1$1(paddings.left, paddings.top, width, height);
}
/**
 * Checks whether provided element is an instance of the SVGGraphicsElement.
 *
...
var isSVGGraphicsElement$1$1$1 = function () {
  // Some browsers, namely IE and Edge, don't have the SVGGraphicsElement
  // interface.
  if (typeof SVGGraphicsElement !== 'undefined') {
    return function (target) {
      return target instanceof getWindowOf$1$1$1(target).SVGGraphicsElement;
    };
  } // If it's so, then check that element is at least an instance of the
  // SVGElement and that it has the "getBBox" method.
  // eslint-disable-next-line no-extra-parens
  ...
  return function (target) {
    return target instanceof getWindowOf$1$1$1(target).SVGElement && typeof target.getBBox === 'function';
  };
}();
/**
 * Checks whether provided element is a document element (<html>).
...
function isDocumentElement$1$1$1(target) {
  return target === getWindowOf$1$1$1(target).document.documentElement;
}
/**
 * Calculates an appropriate content rectangle for provided html or svg element.
 *
...
function getContentRect$1$1$1(target) {
  if (!isBrowser$1$1$1) {
    return emptyRect$1$1$1;
  }

  if (isSVGGraphicsElement$1$1$1(target)) {
    return getSVGContentRect$1$1$1(target);
  }

  return getHTMLElementContentRect$1$1$1(target);
}
/**
 * Creates rectangle with an interface of the DOMRectReadOnly.
 * Spec: https://drafts.fxtf.org/geometry/#domrectreadonly
...
function createReadOnlyRect$1$1$1(_a) {
  var x = _a.x,
      y = _a.y,
      width = _a.width,
      height = _a.height; // If DOMRectReadOnly is available use it as a prototype for the rectangle.
...
function createRectInit$1$1$1(x, y, width, height) {
  return {
    x: x,
    y: y,
    width: width,
...
function () {
  ...
  function ResizeObservation(target) {
    ...
    this.contentRect_ = createRectInit$1$1$1(0, 0, 0, 0);
    this.target = target;
  }
  /**
   * Updates content rectangle and tells whether it's width or height properties
  ...
  ResizeObservation.prototype.isActive = function () {
    var rect = getContentRect$1$1$1(this.target);
    this.contentRect_ = rect;
    return rect.width !== this.broadcastWidth || rect.height !== this.broadcastHeight;
  };
  /**
...
function () {
   ...
   */
  function ResizeObserverEntry(target, rectInit) {
    var contentRect = createReadOnlyRect$1$1$1(rectInit); // According to the specification following properties are not writable
    // and are also not enumerable in the native implementation.
    //
    // Property accessors are not being used as they'd require to define a
    // private WeakMap storage which may cause memory leaks in browsers that
...
function () {
  ...
  function ResizeObserverSPI(callback, controller, callbackCtx) {
    ...
    this.observations_ = new MapShim$1$1$1();
  ...
  ResizeObserverSPI.prototype.observe = function (target) {
    ...
    if (!(target instanceof getWindowOf$1$1$1(target).Element)) {
      throw new TypeError('parameter 1 is not of type "Element".');
    }
    ...
    observations.set(target, new ResizeObservation$1$1$1(target));
    this.controller_.addObserver(this); // Force the update of observations.
  ...
  ResizeObserverSPI.prototype.broadcastActive = function () {
    ...
    var entries = this.activeObservations_.map(function (observation) {
      return new ResizeObserverEntry$1$1$1(observation.target, observation.broadcastRect());
    });
    this.callback_.call(ctx, entries, ctx);
    this.clearActive();
  };
...
var observers$1$1$1 = typeof WeakMap !== 'undefined' ? new WeakMap() : new MapShim$1$1$1();
/**
 * ResizeObserver API. Encapsulates the ResizeObserver SPI implementation
 * exposing only those methods and properties that are defined in the spec.
 */

var ResizeObserver$1$1$1 =
/** @class */
function () {
  /**
   * Creates a new instance of ResizeObserver.
  ...
  function ResizeObserver(callback) {
    ...
    var controller = ResizeObserverController$1$1$1.getInstance();
    var observer = new ResizeObserverSPI$1$1$1(callback, controller, this);
    observers$1$1$1.set(this, observer);
  }
...
['observe', 'unobserve', 'disconnect'].forEach(function (method) {
  ResizeObserver$1$1$1.prototype[method] = function () {
    var _a;

    return (_a = observers$1$1$1.get(this))[method].apply(_a, arguments);
  };
});

var index$1$1$1 = function () {
  // Export existing implementation if available.
  if (typeof global$1$1$1$1.ResizeObserver !== 'undefined') {
    return global$1$1$1$1.ResizeObserver;
  }

  return ResizeObserver$1$1$1;
}();

class Animation$1$1$1 {
    constructor() {
        Animation$1$1$1.activateRequestAnimationFrame();
        this.registerFrameHandler();
    }
    static activateRequestAnimationFrame() {
        if (!Animation$1$1$1.animationFrame) {
            Animation$1$1$1.animationFrame = window
                .requestAnimationFrame(Animation$1$1$1.requestAnimationFrameHandler);
        }
    }
    static deactivateRequestAnimationFrame() {
        if (!Animation$1$1$1.handlerList.length) {
            window.cancelAnimationFrame(Animation$1$1$1.animationFrame);
        }
    }
    static requestAnimationFrameHandler() {
        Animation$1$1$1.handlerList.forEach((handler) => handler());
        Animation$1$1$1.animationFrame = window
            .requestAnimationFrame(Animation$1$1$1.requestAnimationFrameHandler);
    }
    destroy() {
    ...
    addHandler() {
        ...
        if (frameHandler) {
            Animation$1$1$1.activateRequestAnimationFrame();
            Animation$1$1$1.handlerList.push(frameHandler);
        }
    }
    removeHandler() {
        const { handlerList } = Animation$1$1$1;
        const { frameHandler } = this;
        if (frameHandler && handlerList.includes(frameHandler)) {
            const index = handlerList.indexOf(frameHandler);
            handlerList.splice(index, 1);
        }
        Animation$1$1$1.deactivateRequestAnimationFrame();
    }
}
Animation$1$1$1.handlerList = [];

const CLASS_NAME_PATTERN$1$1$1 = /class="[^"]+"/ig;
const REF_PATTERN$1$1$1 = /ref="[^"]+"/ig;
const IF_OPEN_PATTERN$1$1$1 = /<If\scondition="\{[^"]+}">/gi;
const IF_CLOSE_PATTERN$1$1$1 = /<\/If>/gi;
const CHOOSE_OPEN_PATTERN$1$1$1 = /<Choose>/gi;
const CHOOSE_CLOSE_PATTERN$1$1$1 = /<\/Choose>/gi;
const CHOOSE_PATTERN$1$1$1 = /<Choose>(.(?!\/Choose>)|\n(?!\/Choose>)|\s(?!\/Choose>))+/gi;
const WHEN_PATTERN$1$1$1 = /<When\scondition="\{[^"]+}">(.(?!\/When>)|\n(?!\/When>)|\s(?!\/When>))+/gi;
const WHEN_OPEN_PATTERN$1$1$1 = /<When\scondition="\{[^"]+}">/gi;
const WHEN_CLOSE_PATTERN$1$1$1 = /<\/When>/gi;
const OTHERWISE_PATTERN$1$1$1 = /<Otherwise>(.(?!\/Otherwise>)|\n(?!\/Otherwise>)|\s(?!\/Otherwise>))+/gi;
const OTHERWISE_OPEN_PATTERN$1$1$1 = /<Otherwise>/gi;
const OTHERWISE_CLOSE_PATTERN$1$1$1 = /<\/Otherwise>/gi;

class TemplateEngine$1$1$1 extends Animation$1$1$1 {
    constructor(template, container) {
        super();
        this.childNodesField = [];
        this.templateField = '';
    ...
    static getRenderStringWithClassNames(renderString, params = {}) {
        ...
        if (!css)
            return renderString;
        const classNameStringList = renderString.match(CLASS_NAME_PATTERN$1$1$1);
        if (!classNameStringList)
            return renderString;
        return classNameStringList.reduce((acc, classNameString) => {
            const classNameList = classNameString.replace('class="', '').replace('"', '').split(' ');
    ...
    static getTemplateExecutor(template$1$1$1$1) {
        let processedTemplate = TemplateEngine$1$1$1
            .getTemplateExecutorStringWithLodashConditions(template$1$1$1$1);
        processedTemplate = TemplateEngine$1$1$1
            .getTemplateExecutorStringWithLodashSwitches(processedTemplate)
            .replace(/\s*%>[\s\n]*<%\s*/g, ' ');
        return template$1$1$1(processedTemplate);
    }
    static getTemplateExecutorStringWithLodashConditions(template) {
        const conditionList = template.match(IF_OPEN_PATTERN$1$1$1);
        if (!conditionList)
            return template;
        return conditionList.reduce((acc, item) => {
            const condition = item.replace(/^<If\scondition="\{/i, '').replace(/}">$/, '');
            return acc.replace(item, `<% if (${condition}) { %>`);
        }, template).replace(IF_CLOSE_PATTERN$1$1$1, '<% } %>');
    }
    static getTemplateExecutorStringWithLodashSwitches(template) {
        if (!CHOOSE_OPEN_PATTERN$1$1$1.test(template))
            return template;
        const chooseList = template.match(CHOOSE_PATTERN$1$1$1) || [];
        return chooseList.reduce((acc, item) => {
            return this.getTemplateExecutorStringWithLodashWhen(acc, item.replace(/<Choose>[^<]*/i, ''));
        }, template).replace(CHOOSE_OPEN_PATTERN$1$1$1, '').replace(CHOOSE_CLOSE_PATTERN$1$1$1, '');
    }
    static getTemplateExecutorStringWithLodashWhen(template, data) {
        const whenList = data.match(WHEN_PATTERN$1$1$1) || [];
        const otherwiseList = data.match(OTHERWISE_PATTERN$1$1$1) || [];
        const processedString = whenList.reduce((acc, item, index) => {
            const openBlockList = item.match(WHEN_OPEN_PATTERN$1$1$1);
            if (!openBlockList)
                return acc;
            const openBlock = openBlockList[0];
            const condition = openBlock.replace(/^<When\scondition="\{/i, '').replace(/}">$/, '');
            const processedBlock = item.replace(openBlock, `<%${index ? ' else' : ''} if (${condition}) { %>`);
            return acc.replace(item, processedBlock);
        }, template).replace(WHEN_CLOSE_PATTERN$1$1$1, '<% } %>');
        return otherwiseList.length === 1
            ? otherwiseList.reduce((acc, item) => {
                const processedBlock = item
                    .replace(OTHERWISE_OPEN_PATTERN$1$1$1, whenList.length ? '<% else {  %>' : '');
                return acc.replace(item, processedBlock);
            }, processedString).replace(OTHERWISE_CLOSE_PATTERN$1$1$1, whenList.length ? '<% } %>' : '')
            : processedString;
    }
    get childNodes() {
        return this.childNodesField;
    ...
    set template(value) {
        this.templateExecutor = TemplateEngine$1$1$1.getTemplateExecutor(value);
        this.templateField = value;
    }
    get container() {
        return this.containerField;
    ...
    getRenderString(params) {
        ...
        if (!templateExecutor)
            return '';
        let renderString = templateExecutor(omit$1$1$1(params, ['css']));
        renderString = TemplateEngine$1$1$1.getRenderStringWithClassNames(renderString, params);
        return TemplateEngine$1$1$1.getRenderStringWithVariables(renderString, params);
    }
    saveRefs() {
        const { container } = this;
        const refs = this.template.match(REF_PATTERN$1$1$1);
        this.refMap = refs ? refs.reduce((acc, item) => {
            const name = item.replace(/^ref="/, '').replace(/"$/, '');
            if (!name)
                return acc;
    ...
    replaceRenderString(renderString, replace) {
        const container = this.container;
        const { childNodes } = container;
        const proxyChildNodes = TemplateEngine$1$1$1.getProxyChildNodes(renderString);
        const replaceNodeList = replace.nodeList;
        if (!replaceNodeList || replaceNodeList.length !== proxyChildNodes.length)
            return;
        proxyChildNodes.forEach((childNode, index) => {
    ...
    addRenderStringWithoutRef(append, renderString) {
        this.childNodes = TemplateEngine$1$1$1.getProxyChildNodes(renderString);
        this.addChildNodesWithoutRef(append);
    }
    addChildNodesWithoutRef(append) {
        const container = this.container;
...
const getKeyCode$1$1$1 = (e) => e ? e.which || e.keyCode : null;

const ENTER_CODE$1$1$1 = 13;
const LEFT_CODE$1$1$1 = 37;
const RIGHT_CODE$1$1$1 = 39;
const UP_CODE$1$1$1 = 38;
const DOWN_CODE$1$1$1 = 40;
const NON_BREAKING_SPACE$1$1$1 = '&nbsp;';

var css$2$1$1$1 = {"root":"root-term-️cab119304dc90a90f699151e7c15d7ee","visible":"visible-term-️cab119304dc90a90f699151e7c15d7ee","content":"content-term-️cab119304dc90a90f699151e7c15d7ee","helpContainer":"helpContainer-term-️cab119304dc90a90f699151e7c15d7ee","inputContainer":"inputContainer-term-️cab119304dc90a90f699151e7c15d7ee"};

var lineTemplate$1$1$1 = "<div ref=\"root\" class=\"root visible {className}\">\n  <div ref=\"content\" class=\"content\">\n    <div ref=\"helpContainer\" class=\"labelText helpContainer\">{nbs}</div>\n    <div ref=\"labelContainer\"></div>\n    <div ref=\"inputContainer\" class=\"inputContainer\"></div>\n  </div>\n</div>\n";

class BaseCaret$1$1$1 extends TemplateEngine$1$1$1 {
    constructor() {
        super(...arguments);
        this.value = '';
        this.prevLock = false;
...
var SimpleCaretTemplate$1$1$1 = "<span ref=\"root\" class=\"root\">\n  <span ref=\"character\" class=\"character\"></span>\n</span>\n";

var css$3$1$1$1 = {"root":"root-term-️e70267db75c0341d98d4d4a58c7a4fe6","carriage-return-blink":"carriage-return-blink-term-️e70267db75c0341d98d4d4a58c7a4fe6","lock":"lock-term-️e70267db75c0341d98d4d4a58c7a4fe6","busy":"busy-term-️e70267db75c0341d98d4d4a58c7a4fe6","none":"none-term-️e70267db75c0341d98d4d4a58c7a4fe6","carriage-return-busy":"carriage-return-busy-term-️e70267db75c0341d98d4d4a58c7a4fe6","hidden":"hidden-term-️e70267db75c0341d98d4d4a58c7a4fe6"};

class SimpleCaret$1$1$1 extends BaseCaret$1$1$1 {
    constructor(container) {
        super(SimpleCaretTemplate$1$1$1, container);
        this.render({ css: css$3$1$1$1 });
    }
    updateLockStyles() {
        const root = this.getRef('root');
        const { lock, prevLock } = this;
        if (!root || lock === prevLock)
            return;
        return lock ? root.classList.add(css$3$1$1$1.lock) : root.classList.remove(css$3$1$1$1.lock);
    }
    updateBusyStyles() {
        const root = this.getRef('root');
        const { busy, prevBusy } = this;
        if (!root || busy === prevBusy)
            return;
        return busy ? root.classList.add(css$3$1$1$1.busy) : root.classList.remove(css$3$1$1$1.busy);
    }
    updateHiddenStyles() {
        const root = this.getRef('root');
        const { hidden, prevHidden } = this;
        if (!root || hidden === prevHidden)
            return;
        return hidden ? root.classList.add(css$3$1$1$1.hidden) : root.classList.remove(css$3$1$1$1.hidden);
    }
    setValue(value) {
        const character = this.getRef('character');
        if (character && this.value !== value) {
...
class CaretFactory$1$1$1 {
    constructor() { }
    static registerCaret(name, caret) {
        CaretFactory$1$1$1.caretMap[name] = caret;
    }
    static getInstance() {
        if (!CaretFactory$1$1$1.instance)
            CaretFactory$1$1$1.instance = new CaretFactory$1$1$1();
        return CaretFactory$1$1$1.instance;
    }
    create(name, container) {
        return CaretFactory$1$1$1.caretMap[name]
            ? new CaretFactory$1$1$1.caretMap[name](container) : null;
    }
}
CaretFactory$1$1$1.caretMap = {
    simple: SimpleCaret$1$1$1,
};
...
var css$5$1$1$1 = {"secret":"secret-term-️d139f1b48647dd08a4d620b7f948a15f"};
...
var matchHtmlRegExp$1$1$1 = /["'&<>]/;
/**
 * Module exports.
 * @public
 */

var escapeHtml_1$1$1$1 = escapeHtml$1$1$1;
/**
 * Escape special characters in the given string of html.
 *
 * @param  {string} string The string to escape for inserting into HTML
...
function escapeHtml$1$1$1(string) {
  var str = '' + string;
  var match = matchHtmlRegExp$1$1$1.exec(str);
...
const getStartIntersectionString$1$1$1 = (main, target) => {
    if (target.indexOf(main) === 0)
        return { str: main, isFull: true };
    if (main[0] !== target[0])
        return { str: '', isFull: false };
...
const DATA_INDEX_ATTRIBUTE_NAME$1$1$1 = 'data-index';
const SECRET_CHARACTER$1$1$1 = '•';

class BaseInput$1$1$1 extends TemplateEngine$1$1$1 {
    constructor(template, container, cssData) {
        super(template, container);
        this.characterWidth = 8;
        this.characterHeight = 16;
    ...
    static getValueString(value, params = {}) {
        const { secret = false } = params;
        return isString$1$1$1(value)
            ? secret ? BaseInput$1$1$1.convertSecret(value) : value
            : value.reduce((acc, item) => {
                const str = isString$1$1$1(item) ? item : item.str;
                const val = secret && (isString$1$1$1(item) || !item.lock)
                    ? BaseInput$1$1$1.convertSecret(str) : str;
                return `${acc}${val}`;
            }, '');
    }
    static getFragmentTemplate(str, params) {
        const { className = '', secret = false, index } = params;
        const composedClassName = [secret ? css$5$1$1$1.secret : '', className].join(' ');
        const processedString = BaseInput$1$1$1.getNormalizedTemplateString(secret
            ? BaseInput$1$1$1.convertSecret(str) : str);
        return `<span
      ${DATA_INDEX_ATTRIBUTE_NAME$1$1$1}="${index}"
      ref="fragment-${index}"
      class="${composedClassName}">${processedString}</span>`;
    }
    static getNormalizedTemplateString(str) {
        return escapeHtml_1$1$1$1(str).replace(/\s/g, NON_BREAKING_SPACE$1$1$1);
    }
    static getValueFragmentTemplate(valueFragment, index, params = {}) {
        const { secret } = params;
        if (isString$1$1$1(valueFragment)) {
            return BaseInput$1$1$1.getFragmentTemplate(valueFragment, { index, secret });
        }
        const { str, className = '', lock } = valueFragment;
        const isSecret = !lock && secret;
        return BaseInput$1$1$1.getFragmentTemplate(str, { className, index, secret: isSecret });
    }
    static getValueTemplate(value, params = {}) {
        if (isString$1$1$1(value))
            return BaseInput$1$1$1.getNormalizedTemplateString(value);
        return value.reduce((acc, item, index) => {
            return `${acc}${BaseInput$1$1$1.getValueFragmentTemplate(item, index, params)}`;
        }, '');
    }
    static getUpdatedValueField(value, prevValue) {
        if (isString$1$1$1(prevValue))
            return value;
        let checkValue = value;
        let stop = false;
        const updatedValueField = prevValue.reduce((acc, item) => {
            const isStringItem = isString$1$1$1(item);
            const itemStr = (isStringItem ? item : item.str);
            const { str, isFull } = getStartIntersectionString$1$1$1(itemStr, checkValue);
            if (str && !stop) {
                acc.push(isStringItem ? str : Object.assign(Object.assign({}, item), { str }));
                checkValue = checkValue.substring(str.length);
                stop = !isFull;
        ...
        checkValue.split('').forEach(char => updatedValueField.push(char));
        return updatedValueField.filter(item => isString$1$1$1(item) ? item : item.str);
    }
    static getLockString(value) {
        if (isString$1$1$1(value))
            return '';
    ...
    static convertSecret(str) {
        return (new Array(str.length)).fill(SECRET_CHARACTER$1$1$1).join('');
    }
    get characterSize() {
        const { characterContainer } = this;
        return characterContainer
    ...
    get lockString() {
        const { valueField } = this;
        return BaseInput$1$1$1.getLockString(valueField);
    }
    get hiddenCaret() {
        return this.isCaretHidden;
    }
    ...
    getValueItemString(index) {
        const { valueField } = this;
        if (isString$1$1$1(valueField))
            return index ? '' : valueField;
        const item = valueField[index];
        if (!item)
            return '';
        return isString$1$1$1(item) ? item : item.str;
    }
    getSimpleValue(showSecret = true) {
        const { secretField } = this;
        return BaseInput$1$1$1.getValueString(this.valueField, { secret: secretField && !showSecret });
    }
    // tslint:disable-next-line:no-empty
    moveCaretToEnd(isForce = false) { }
    addEventListener(type, listener, options) {
    ...
    getEndOffset() {
        ...
        if (!rowCharactersCount)
            return { left: 0, top: 0 };
        const charactersCount = BaseInput$1$1$1.getValueString(valueField).length;
        const row = Math.floor(charactersCount / rowCharactersCount);
        const relativePosition = charactersCount - row * rowCharactersCount;
        return {
            left: relativePosition * characterSize.width,
    ...
    getElementFormattedValueFragment(element) {
        ...
        if (isString$1$1$1(valueField))
            return null;
        const dataIndex = element.getAttribute(DATA_INDEX_ATTRIBUTE_NAME$1$1$1);
        const valueFieldItem = dataIndex ? valueField[Number(dataIndex)] : null;
        return !valueFieldItem || isString$1$1$1(valueFieldItem)
            ? null : valueFieldItem;
    }
    setCharacterContainer() {
        const root = this.getRef('root');
        if (root) {
            ...
            characterContainer.style.left = '0';
            characterContainer.style.top = '0';
            characterContainer.innerHTML = NON_BREAKING_SPACE$1$1$1;
            root.appendChild(characterContainer);
            this.characterContainer = characterContainer;
        }
    }
...
const STRINGIFY_HTML_PATTERN$1$1$1 = /<[^>]+>/g;
const NON_BREAKING_SPACE_PATTERN$1$1$1 = /&nbsp;/g;

const TEXT_NODE_TYPE$1$1$1 = 3;
const CHANGE_EVENT_TYPE$1$1$1 = 'change';

class ContentEditableInput$1$1$1 extends BaseInput$1$1$1 {
    constructor(container) {
        super(template$3$1$1$1, container, css$4$1$1$1);
        this.externalChangeListeners = [];
        this.isDisabled = false;
        this.changeHandler = (e) => {
            this.updateValueField();
    ...
    static getStyledValueTemplate(val, params = {}) {
        return BaseInput$1$1$1.getValueTemplate(val, params);
    }
    static getLastTextNode(root) {
        const { lastChild } = root;
        if (!lastChild)
            return null;
        if (lastChild.nodeType === TEXT_NODE_TYPE$1$1$1)
            return lastChild;
        return ContentEditableInput$1$1$1.getLastTextNode(lastChild);
    }
    static checkChildNode(root, checkNode) {
        if (root === checkNode)
            return true;
        const { parentNode } = checkNode;
        return parentNode ? ContentEditableInput$1$1$1.checkChildNode(root, parentNode) : false;
    }
    static getHtmlStringifyValue(html) {
        return html.replace(NON_BREAKING_SPACE_PATTERN$1$1$1, ' ').replace(STRINGIFY_HTML_PATTERN$1$1$1, '');
    }
    static getNodeOffset(root, target, baseOffset = 0) {
        const { parentNode } = target;
        if (!parentNode || root === target)
        ...
        const offset = prevNodes.reduce((acc, node) => {
            const value = node.nodeType === TEXT_NODE_TYPE$1$1$1
                ? node.nodeValue
                : ContentEditableInput$1$1$1.getHtmlStringifyValue(node.innerHTML);
            return acc + (value ? value.length : 0);
        }, 0);
        return root === parentNode
            ? baseOffset + offset
            : ContentEditableInput$1$1$1.getNodeOffset(root, parentNode, baseOffset + offset);
    }
    set hiddenCaret(isCaretHidden) {
        if (this.isCaretHidden === isCaretHidden)
            return;
        const root = this.getRef('input');
        if (isCaretHidden) {
            root.classList.add(css$4$1$1$1.hiddenCaret);
        }
        else {
            root.classList.remove(css$4$1$1$1.hiddenCaret);
        }
        this.isCaretHidden = isCaretHidden;
    }
    set value(val) {
    ...
    get caretPosition() {
        ...
        if (!selection || !selection.isCollapsed || !selection.anchorNode)
            return -1;
        const { anchorNode } = selection;
        if (!ContentEditableInput$1$1$1.checkChildNode(root, selection.anchorNode))
            return -1;
        return ContentEditableInput$1$1$1.getNodeOffset(root, anchorNode, anchorNode.nodeType === TEXT_NODE_TYPE$1$1$1 ? selection.anchorOffset : 0);
    }
    set caretPosition(position) {
        if (position < 0)
            return;
        ...
        let relativeOffset = 0;
        const targetNode = Array.prototype.find.call(root.childNodes, (childNode) => {
            const length = ((childNode.nodeType === TEXT_NODE_TYPE$1$1$1
                ? childNode.nodeValue
                : ContentEditableInput$1$1$1.getHtmlStringifyValue(childNode.innerHTML)) || '')
                .length;
            relativeOffset = offset;
            offset += length;
            return position <= offset;
        ...
        if (!selection || !targetNode)
            return;
        const range = new Range();
        const targetChildNode = targetNode.nodeType === TEXT_NODE_TYPE$1$1$1
            ? targetNode : targetNode.firstChild;
        range.setStart(targetChildNode, position - relativeOffset);
        range.setEnd(targetChildNode, position - relativeOffset);
        selection.removeAllRanges();
    ...
    moveCaretToEnd(isForce = false) {
        ...
        const range = document.createRange();
        const selection = window.getSelection();
        const node = ContentEditableInput$1$1$1.getLastTextNode(root);
        if (!node)
            return;
        range.selectNodeContents(node);
        range.collapse(false);
    ...
    addEventListener(type, listener, options) {
        if (type === CHANGE_EVENT_TYPE$1$1$1) {
            this.externalChangeListeners.push(listener);
        }
        else {
            super.addEventListener(type, listener, options);
    ...
    getInputValue() {
        const root = this.getRef('input');
        const data = root.innerHTML;
        const items = data.replace(/<\/span>[^<]*</g, '</span><').split('</span>').filter(identity$1$1$1);
        return items.reduce((acc, item) => {
            var _a;
            const index = (((_a = item.match(/data-index="[0-9]+"/)) === null || _a === void 0 ? void 0 : _a[0]) || '').replace(/[^0-9]/g, '');
            if (index) {
                const prevValue = this.getValueItemString(Number(index));
                const updatedValue = ContentEditableInput$1$1$1.getHtmlStringifyValue(item)
                    .replace(new RegExp(`${SECRET_CHARACTER$1$1$1}+`), prevValue);
                return `${acc}${updatedValue}`;
            }
            return `${acc}${ContentEditableInput$1$1$1.getHtmlStringifyValue(item)}`;
        }, '');
    }
    updateValueField() {
        if (this.preventLockUpdate())
        ...
        let updatedCaretPosition = caretPosition;
        if (isDisabled) {
            updatedCaretPosition = Math.min(caretPosition, BaseInput$1$1$1.getValueString(this.valueField).length);
        }
        else {
            this.valueField = BaseInput$1$1$1.getUpdatedValueField(this.getInputValue(), this.valueField);
        }
        this.updateContent();
        this.caretPosition = updatedCaretPosition;
    }
    preventLockUpdate() {
        ...
        if (isString$1$1$1(valueField))
            return false;
        const value = this.getInputValue();
        const lockStr = BaseInput$1$1$1.getLockString(valueField);
        const deleteUnlockPart = lockStr
            && lockStr.indexOf(value) === 0
            && lockStr.length > value.length;
        if (deleteUnlockPart) {
            const lastLockIndex = this.valueField
                .reduce((acc, item, index) => {
                return !isString$1$1$1(item) && item.lock ? index : acc;
            }, -1);
            this.valueField = this.valueField
                .filter((_, index) => index <= lastLockIndex);
        }
    ...
    setString() {
        ...
        const hidden = this.getRef('hidden');
        if (input && hidden) {
            const str = ContentEditableInput$1$1$1.getStyledValueTemplate(this.valueField, {
                secret: secretField,
            });
            input.innerHTML = str;
            hidden.innerHTML = str;
    ...
    updateStyles() {
        ...
        if (input && hidden) {
            Array.prototype.forEach.call(hidden.childNodes, (childNode, index) => {
                if (childNode.nodeType !== TEXT_NODE_TYPE$1$1$1) {
                    const { color } = window.getComputedStyle(childNode);
                    if (color)
                        input.childNodes[index].style.textShadow = `0 0 0 ${color}`;
                }
...
var template$4$1$1$1 = "<div ref=\"root\">\n  <div ref=\"input\" class=\"root\">{value}</div>\n</div>\n";

var css$6$1$1$1 = {"root":"root-term-️457efebe90f812d594ffccb8790b07ab"};

class ViewableInput$1$1$1 extends BaseInput$1$1$1 {
    set value(val) {
        this.valueField = val;
        const root = this.getRef('input');
        if (root)
            root.innerHTML = BaseInput$1$1$1.getValueTemplate(this.valueField);
    }
    constructor(container) {
        super(template$4$1$1$1, container, css$6$1$1$1);
    }
    render() {
        super.render({ css: css$6$1$1$1, value: BaseInput$1$1$1.getValueTemplate(this.valueField) });
    }
    getRootElement() {
        return this.getRef('input');
    }
...
var css$7$1$1$1 = {"label":"label-term-️679afd4849096768cfa38bb85a2048b8","labelTextContainer":"labelTextContainer-term-️679afd4849096768cfa38bb85a2048b8","labelText":"labelText-term-️679afd4849096768cfa38bb85a2048b8"};

var template$5$1$1$1 = "<if condition=\"{label || delimiter}\">\n  <div class=\"label\">\n    <if condition=\"{label}\">\n      <div class=\"labelTextContainer\">\n        <span class=\"labelText\" ref=\"label\">{label}</span>\n      </div>\n      <div>\n        <span class=\"labelText\">{nbs}</span>\n      </div>\n    </if>\n    <if condition=\"{delimiter}\">\n      <div class=\"labelTextContainer\">\n        <span class=\"labelText\" ref=\"delimiter\">{delimiter}</span>\n      </div>\n      <div>\n        <span class=\"labelText\">{nbs}</span>\n      </div>\n    </if>\n  </div>\n</if>\n\n";

class Label$1$1$1 extends TemplateEngine$1$1$1 {
    constructor(container, params = {}) {
        super(template$5$1$1$1, container);
        this.label = '';
        this.delimiter = '';
        this.reRender = false;
        this.label = params.label || '';
    ...
    render() {
        const { label, delimiter } = this;
        super.render({
            css: css$7$1$1$1, label, delimiter, nbs: NON_BREAKING_SPACE$1$1$1,
        }, this.reRender ? { replace: this } : {});
        this.reRender = true;
    }
}

class Line$1$1$1 extends TemplateEngine$1$1$1 {
    constructor(container, params = {}) {
        super(lineTemplate$1$1$1, container);
        this.isVisible = true;
        this.heightField = 0;
        this.secretField = false;
        this.initialValue = '';
        this.className = '';
        this.editable = false;
        this.onSubmit = noop$2$1$1;
        this.onChange = noop$2$1$1;
        this.onUpdateCaretPosition = noop$2$1$1;
        this.caretPosition = -1;
        this.updateHeight = () => {
            const root = this.getRef('root');
            if (!root)
        ...
        this.keyDownHandler = (e) => {
            ({
                [ENTER_CODE$1$1$1]: this.submitHandler,
                [LEFT_CODE$1$1$1]: this.lockCaret,
                [RIGHT_CODE$1$1$1]: this.lockCaret,
                [UP_CODE$1$1$1]: this.lockCaret,
                [DOWN_CODE$1$1$1]: this.lockCaret,
            }[Number(getKeyCode$1$1$1(e))] || noop$2$1$1)(e);
        };
        this.submitHandler = (e) => {
            const { onSubmit, inputField, secret } = this;
            const value = (inputField === null || inputField === void 0 ? void 0 : inputField.value) || '';
            ...
            else if (isArray$2$1$1(value)) {
                formattedValue = secret ? value.filter(item => get$2$1$1(item, 'lock')) : value;
            }
            e.preventDefault();
            if (inputField && onSubmit) {
                onSubmit({
        ...
        this.lockCaret = () => {
            ...
            if (!caret)
                return;
            caret.lock = true;
            this.lockTimeout = setTimeout(() => caret.lock = false, LOCK_TIMEOUT$1$1$1);
        };
        this.setParams(params);
        this.container = container;
        this.render({ label: params.label, delimiter: params.delimiter });
    ...
    static getHeight(params) {
        const { delimiter, label, value, width, itemSize } = params;
        const { width: itemWidth, height: itemHeight } = itemSize;
        const valueString = BaseInput$1$1$1.getValueString(value);
        const labelLength = (delimiter ? delimiter.length + 1 : 0)
            + (label ? label.length + 1 : 0);
        const rowItemsCount = Math
            .floor((width - Line$1$1$1.itemHorizontalPadding - labelLength * itemWidth) / itemWidth);
        return Math.ceil((valueString.length || 1) / rowItemsCount) * itemHeight
            + 2 * Line$1$1$1.itemVerticalPadding;
    }
    get value() {
        const { inputField } = this;
        return inputField ? inputField.value : '';
    ...
    set visible(value) {
        ...
        this.isVisible = value;
        if (value) {
            root.classList.add(css$2$1$1$1.visible);
        }
        else {
            root.classList.remove(css$2$1$1$1.visible);
        }
    }
    get hidden() {
        return this.isHidden;
    ...
    render(params) {
        ...
        if (this.label)
            this.label.destroy();
        super.render({
            css: css$2$1$1$1, editable, className, nbs: NON_BREAKING_SPACE$1$1$1,
        }, reRender ? { replace: this } : {});
        this.inputField = editable
            ? new ContentEditableInput$1$1$1(this.getRef('inputContainer'))
            : new ViewableInput$1$1$1(this.getRef('inputContainer'));
        this.label = new Label$1$1$1(this.getRef('labelContainer'), params);
        this.inputField.value = this.initialValue;
        this.inputField.secret = secret;
    }
    setCaret(name = 'simple') {
        const { inputField, editable } = this;
        this.removeCaret();
        const caret = Line$1$1$1.cf.create(name, this.getRef('inputContainer'));
        if (!inputField)
            return;
        if (caret && editable) {
            inputField.hiddenCaret = true;
    ...
    setParams(params) {
        const { onUpdateCaretPosition = noop$2$1$1, onChange = noop$2$1$1, onSubmit = noop$2$1$1, editable = true, className = '', value, secret = false, } = params;
        this.className = className;
        this.onSubmit = onSubmit;
        this.onChange = onChange;
        this.onUpdateCaretPosition = onUpdateCaretPosition;
    ...
    showCaret(caretPosition) {
        ...
        caret.hidden = false;
        const character = value[caretPosition] === ' '
            ? NON_BREAKING_SPACE$1$1$1 : value[caretPosition] || NON_BREAKING_SPACE$1$1$1;
        const top = Math.round(height * row);
        const left = Math.round((caretPosition - row * rowLength) * width);
        caret.setPosition(left, top);
        caret.setValue(character);
...
Line$1$1$1.cf = CaretFactory$1$1$1.getInstance();
Line$1$1$1.itemVerticalPadding = 4;
Line$1$1$1.itemHorizontalPadding = 16;

function unwrapExports$1$1$1(x) {
  return x && x.__esModule && Object.prototype.hasOwnProperty.call(x, 'default') ? x['default'] : x;
}
...
var guid$1$1$1 = createCommonjsModule$1$1$1(function (module, exports) {
  exports.__esModule = true;
...
unwrapExports$1$1$1(guid$1$1$1);
var guid_1$1$1$1 = guid$1$1$1.Guid;
/** Detect free variable `global` from Node.js. */

var freeGlobal$1$1$1$1 = typeof global == 'object' && global && global.Object === Object && global;
/** Detect free variable `self`. */

var freeSelf$1$1$1$1 = typeof self == 'object' && self && self.Object === Object && self;
/** Used as a reference to the global object. */

var root$1$1$1$1 = freeGlobal$1$1$1$1 || freeSelf$1$1$1$1 || Function('return this')();
/** Built-in value references. */

var Symbol$1$1$1$1 = root$1$1$1$1.Symbol;
/** Used for built-in method references. */

var objectProto$g$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$d$1$1$1 = objectProto$g$1$1$1.hasOwnProperty;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
 * of values.
...
var nativeObjectToString$2$1$1$1 = objectProto$g$1$1$1.toString;
/** Built-in value references. */

var symToStringTag$2$1$1$1 = Symbol$1$1$1$1 ? Symbol$1$1$1$1.toStringTag : undefined;
/**
 * A specialized version of `baseGetTag` which ignores `Symbol.toStringTag` values.
 *
 * @private
...
function getRawTag$1$1$1$1(value) {
  var isOwn = hasOwnProperty$d$1$1$1.call(value, symToStringTag$2$1$1$1),
      tag = value[symToStringTag$2$1$1$1];

  try {
    value[symToStringTag$2$1$1$1] = undefined;
    var unmasked = true;
  } catch (e) {}

  var result = nativeObjectToString$2$1$1$1.call(value);

  if (unmasked) {
    if (isOwn) {
      value[symToStringTag$2$1$1$1] = tag;
    } else {
      delete value[symToStringTag$2$1$1$1];
    }
  }
...
var objectProto$1$1$1$1$1 = Object.prototype;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
 * of values.
...
var nativeObjectToString$1$1$1$1$1 = objectProto$1$1$1$1$1.toString;
/**
 * Converts `value` to a string using `Object.prototype.toString`.
 *
 * @private
...
function objectToString$1$1$1$1(value) {
  return nativeObjectToString$1$1$1$1$1.call(value);
}
/** `Object#toString` result references. */


var nullTag$1$1$1$1 = '[object Null]',
    undefinedTag$1$1$1$1 = '[object Undefined]';
/** Built-in value references. */

var symToStringTag$1$1$1$1$1 = Symbol$1$1$1$1 ? Symbol$1$1$1$1.toStringTag : undefined;
/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
...
function baseGetTag$1$1$1$1(value) {
  if (value == null) {
    return value === undefined ? undefinedTag$1$1$1$1 : nullTag$1$1$1$1;
  }

  return symToStringTag$1$1$1$1$1 && symToStringTag$1$1$1$1$1 in Object(value) ? getRawTag$1$1$1$1(value) : objectToString$1$1$1$1(value);
}
/**
 * Checks if `value` is object-like. A value is object-like if it's not `null`
 * and has a `typeof` result of "object".
...
function isObjectLike$1$1$1$1(value) {
  return value != null && typeof value == 'object';
}
/** `Object#toString` result references. */


var symbolTag$3$1$1$1 = '[object Symbol]';
/**
 * Checks if `value` is classified as a `Symbol` primitive or object.
 *
 * @static
...
function isSymbol$1$1$1$1(value) {
  return typeof value == 'symbol' || isObjectLike$1$1$1$1(value) && baseGetTag$1$1$1$1(value) == symbolTag$3$1$1$1;
}
/**
 * A specialized version of `_.map` for arrays without support for iteratee
 * shorthands.
...
function arrayMap$1$1$1$1(array, iteratee) {
  var index = -1,
      length = array == null ? 0 : array.length,
      result = Array(length);
...
var isArray$1$1$1$1 = Array.isArray;
/** Used as references for various `Number` constants. */

var INFINITY$2$1$1$1 = 1 / 0;
/** Used to convert symbols to primitives and strings. */

var symbolProto$2$1$1$1 = Symbol$1$1$1$1 ? Symbol$1$1$1$1.prototype : undefined,
    symbolToString$1$1$1$1 = symbolProto$2$1$1$1 ? symbolProto$2$1$1$1.toString : undefined;
/**
 * The base implementation of `_.toString` which doesn't convert nullish
 * values to empty strings.
 *
...
function baseToString$1$1$1$1(value) {
  // Exit early for strings to avoid a performance hit in some environments.
  if (typeof value == 'string') {
    return value;
  }

  if (isArray$1$1$1$1(value)) {
    // Recursively convert values (susceptible to call stack limits).
    return arrayMap$1$1$1$1(value, baseToString$1$1$1$1) + '';
  }

  if (isSymbol$1$1$1$1(value)) {
    return symbolToString$1$1$1$1 ? symbolToString$1$1$1$1.call(value) : '';
  }

  var result = value + '';
  return result == '0' && 1 / value == -INFINITY$2$1$1$1 ? '-0' : result;
}
/**
 * Checks if `value` is the
 * [language type](http://www.ecma-international.org/ecma-262/7.0/#sec-ecmascript-language-types)
...
function isObject$1$1$1$1(value) {
  var type = typeof value;
  return value != null && (type == 'object' || type == 'function');
}
/** `Object#toString` result references. */
...
var asyncTag$1$1$1$1 = '[object AsyncFunction]',
    funcTag$3$1$1$1 = '[object Function]',
    genTag$2$1$1$1 = '[object GeneratorFunction]',
    proxyTag$1$1$1$1 = '[object Proxy]';
/**
 * Checks if `value` is classified as a `Function` object.
 *
 * @static
...
function isFunction$1$1$1$1(value) {
  if (!isObject$1$1$1$1(value)) {
    return false;
  } // The use of `Object#toString` avoids issues with the `typeof` operator
  // in Safari 9 which returns 'object' for typed arrays and other constructors.


  var tag = baseGetTag$1$1$1$1(value);
  return tag == funcTag$3$1$1$1 || tag == genTag$2$1$1$1 || tag == asyncTag$1$1$1$1 || tag == proxyTag$1$1$1$1;
}
/** Used to detect overreaching core-js shims. */


var coreJsData$1$1$1$1 = root$1$1$1$1['__core-js_shared__'];
/** Used to detect methods masquerading as native. */

var maskSrcKey$1$1$1$1 = function () {
  var uid = /[^.]+$/.exec(coreJsData$1$1$1$1 && coreJsData$1$1$1$1.keys && coreJsData$1$1$1$1.keys.IE_PROTO || '');
  return uid ? 'Symbol(src)_1.' + uid : '';
}();
/**
 * Checks if `func` has its source masked.
...
function isMasked$1$1$1$1(func) {
  return !!maskSrcKey$1$1$1$1 && maskSrcKey$1$1$1$1 in func;
}
/** Used for built-in method references. */


var funcProto$3$1$1$1 = Function.prototype;
/** Used to resolve the decompiled source of functions. */

var funcToString$3$1$1$1 = funcProto$3$1$1$1.toString;
/**
 * Converts `func` to its source code.
 *
 * @private
...
function toSource$1$1$1$1(func) {
  if (func != null) {
    try {
      return funcToString$3$1$1$1.call(func);
    } catch (e) {}
...
var reRegExpChar$1$1$1$1 = /[\\^$.*+?()[\]{}|]/g;
/** Used to detect host constructors (Safari). */

var reIsHostCtor$1$1$1$1 = /^\[object .+?Constructor\]$/;
/** Used for built-in method references. */

var funcProto$1$1$1$1$1 = Function.prototype,
    objectProto$2$1$1$1$1 = Object.prototype;
/** Used to resolve the decompiled source of functions. */

var funcToString$1$1$1$1$1 = funcProto$1$1$1$1$1.toString;
/** Used to check objects for own properties. */

var hasOwnProperty$1$1$1$1$1 = objectProto$2$1$1$1$1.hasOwnProperty;
/** Used to detect if a method is native. */

var reIsNative$1$1$1$1 = RegExp('^' + funcToString$1$1$1$1$1.call(hasOwnProperty$1$1$1$1$1).replace(reRegExpChar$1$1$1$1, '\\$&').replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, '$1.*?') + '$');
/**
 * The base implementation of `_.isNative` without bad shim checks.
 *
 * @private
...
function baseIsNative$1$1$1$1(value) {
  if (!isObject$1$1$1$1(value) || isMasked$1$1$1$1(value)) {
    return false;
  }

  var pattern = isFunction$1$1$1$1(value) ? reIsNative$1$1$1$1 : reIsHostCtor$1$1$1$1;
  return pattern.test(toSource$1$1$1$1(value));
}
/**
 * Gets the value at `key` of `object`.
 *
...
function getValue$1$1$1$1(object, key) {
  return object == null ? undefined : object[key];
}
/**
 * Gets the native function at `key` of `object`.
...
function getNative$1$1$1$1(object, key) {
  var value = getValue$1$1$1$1(object, key);
  return baseIsNative$1$1$1$1(value) ? value : undefined;
}
/**
 * This method returns `undefined`.
 *
...
function noop$1$1$1$1() {} // No operation performed.
...
function eq$1$1$1$1(value, other) {
  return value === other || value !== value && other !== other;
}
/** Used to match property names within property paths. */


var reIsDeepProp$1$1$1$1 = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
    reIsPlainProp$1$1$1$1 = /^\w*$/;
/**
 * Checks if `value` is a property name and not a property path.
 *
 * @private
...
function isKey$1$1$1$1(value, object) {
  if (isArray$1$1$1$1(value)) {
    return false;
  }
  ...
  if (type == 'number' || type == 'symbol' || type == 'boolean' || value == null || isSymbol$1$1$1$1(value)) {
    return true;
  }

  return reIsPlainProp$1$1$1$1.test(value) || !reIsDeepProp$1$1$1$1.test(value) || object != null && value in Object(object);
}
/* Built-in method references that are verified to be native. */


var nativeCreate$1$1$1$1 = getNative$1$1$1$1(Object, 'create');
/**
 * Removes all key-value entries from the hash.
 *
 * @private
...
function hashClear$1$1$1$1() {
  this.__data__ = nativeCreate$1$1$1$1 ? nativeCreate$1$1$1$1(null) : {};
  this.size = 0;
}
/**
 * Removes `key` and its value from the hash.
...
function hashDelete$1$1$1$1(key) {
  var result = this.has(key) && delete this.__data__[key];
  this.size -= result ? 1 : 0;
  return result;
}
...
var HASH_UNDEFINED$2$1$1$1 = '__lodash_hash_undefined__';
/** Used for built-in method references. */

var objectProto$3$1$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$2$1$1$1$1 = objectProto$3$1$1$1$1.hasOwnProperty;
/**
 * Gets the hash value for `key`.
 *
 * @private
...
function hashGet$1$1$1$1(key) {
  var data = this.__data__;

  if (nativeCreate$1$1$1$1) {
    var result = data[key];
    return result === HASH_UNDEFINED$2$1$1$1 ? undefined : result;
  }

  return hasOwnProperty$2$1$1$1$1.call(data, key) ? data[key] : undefined;
}
/** Used for built-in method references. */


var objectProto$4$1$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$3$1$1$1$1 = objectProto$4$1$1$1$1.hasOwnProperty;
/**
 * Checks if a hash value for `key` exists.
 *
 * @private
...
function hashHas$1$1$1$1(key) {
  var data = this.__data__;
  return nativeCreate$1$1$1$1 ? data[key] !== undefined : hasOwnProperty$3$1$1$1$1.call(data, key);
}
/** Used to stand-in for `undefined` hash values. */


var HASH_UNDEFINED$1$1$1$1$1 = '__lodash_hash_undefined__';
/**
 * Sets the hash `key` to `value`.
 *
 * @private
...
function hashSet$1$1$1$1(key, value) {
  var data = this.__data__;
  this.size += this.has(key) ? 0 : 1;
  data[key] = nativeCreate$1$1$1$1 && value === undefined ? HASH_UNDEFINED$1$1$1$1$1 : value;
  return this;
}
/**
 * Creates a hash object.
...
Hash$1$1$1$1.prototype.clear = hashClear$1$1$1$1;
Hash$1$1$1$1.prototype['delete'] = hashDelete$1$1$1$1;
Hash$1$1$1$1.prototype.get = hashGet$1$1$1$1;
Hash$1$1$1$1.prototype.has = hashHas$1$1$1$1;
Hash$1$1$1$1.prototype.set = hashSet$1$1$1$1;
/**
 * Removes all key-value entries from the list cache.
 *
 * @private
...
function listCacheClear$1$1$1$1() {
  this.__data__ = [];
  this.size = 0;
}
/**
...
function assocIndexOf$1$1$1$1(array, key) {
  var length = array.length;

  while (length--) {
    if (eq$1$1$1$1(array[length][0], key)) {
      return length;
    }
  }
...
var arrayProto$1$1$1$1 = Array.prototype;
/** Built-in value references. */

var splice$1$1$1$1 = arrayProto$1$1$1$1.splice;
/**
 * Removes `key` and its value from the list cache.
 *
 * @private
...
function listCacheDelete$1$1$1$1(key) {
  var data = this.__data__,
      index = assocIndexOf$1$1$1$1(data, key);
  ...
  if (index == lastIndex) {
    ...
    splice$1$1$1$1.call(data, index, 1);
  }
...
function listCacheGet$1$1$1$1(key) {
  var data = this.__data__,
      index = assocIndexOf$1$1$1$1(data, key);
  return index < 0 ? undefined : data[index][1];
}
...
function listCacheHas$1$1$1$1(key) {
  return assocIndexOf$1$1$1$1(this.__data__, key) > -1;
}
/**
 * Sets the list cache `key` to `value`.
 *
...
function listCacheSet$1$1$1$1(key, value) {
  var data = this.__data__,
      index = assocIndexOf$1$1$1$1(data, key);
...
function ListCache$1$1$1$1(entries) {
  var index = -1,
      length = entries == null ? 0 : entries.length;
  this.clear();
...
ListCache$1$1$1$1.prototype.clear = listCacheClear$1$1$1$1;
ListCache$1$1$1$1.prototype['delete'] = listCacheDelete$1$1$1$1;
ListCache$1$1$1$1.prototype.get = listCacheGet$1$1$1$1;
ListCache$1$1$1$1.prototype.has = listCacheHas$1$1$1$1;
ListCache$1$1$1$1.prototype.set = listCacheSet$1$1$1$1;
/* Built-in method references that are verified to be native. */

var Map$2$1$1$1 = getNative$1$1$1$1(root$1$1$1$1, 'Map');
/**
 * Removes all key-value entries from the map.
 *
 * @private
...
function mapCacheClear$1$1$1$1() {
  this.size = 0;
  this.__data__ = {
    'hash': new Hash$1$1$1$1(),
    'map': new (Map$2$1$1$1 || ListCache$1$1$1$1)(),
    'string': new Hash$1$1$1$1()
  };
}
/**
 * Checks if `value` is suitable for use as unique object key.
...
function isKeyable$1$1$1$1(value) {
  var type = typeof value;
  return type == 'string' || type == 'number' || type == 'symbol' || type == 'boolean' ? value !== '__proto__' : value === null;
}
/**
...
function getMapData$1$1$1$1(map, key) {
  var data = map.__data__;
  return isKeyable$1$1$1$1(key) ? data[typeof key == 'string' ? 'string' : 'hash'] : data.map;
}
/**
 * Removes `key` and its value from the map.
 *
...
function mapCacheDelete$1$1$1$1(key) {
  var result = getMapData$1$1$1$1(this, key)['delete'](key);
  this.size -= result ? 1 : 0;
  return result;
}
/**
...
function mapCacheGet$1$1$1$1(key) {
  return getMapData$1$1$1$1(this, key).get(key);
}
/**
 * Checks if a map value for `key` exists.
 *
...
function mapCacheHas$1$1$1$1(key) {
  return getMapData$1$1$1$1(this, key).has(key);
}
/**
 * Sets the map `key` to `value`.
 *
...
function mapCacheSet$1$1$1$1(key, value) {
  var data = getMapData$1$1$1$1(this, key),
      size = data.size;
  data.set(key, value);
  this.size += data.size == size ? 0 : 1;
  return this;
...
function MapCache$1$1$1$1(entries) {
  var index = -1,
      length = entries == null ? 0 : entries.length;
  this.clear();
...
MapCache$1$1$1$1.prototype.clear = mapCacheClear$1$1$1$1;
MapCache$1$1$1$1.prototype['delete'] = mapCacheDelete$1$1$1$1;
MapCache$1$1$1$1.prototype.get = mapCacheGet$1$1$1$1;
MapCache$1$1$1$1.prototype.has = mapCacheHas$1$1$1$1;
MapCache$1$1$1$1.prototype.set = mapCacheSet$1$1$1$1;
/** Error message constants. */

var FUNC_ERROR_TEXT$1$1$1$1 = 'Expected a function';
/**
 * Creates a function that memoizes the result of `func`. If `resolver` is
 * provided, it determines the cache key for storing the result based on the
 * arguments provided to the memoized function. By default, the first argument
...
function memoize$1$1$1$1(func, resolver) {
  if (typeof func != 'function' || resolver != null && typeof resolver != 'function') {
    throw new TypeError(FUNC_ERROR_TEXT$1$1$1$1);
  }
  ...
  memoized.cache = new (memoize$1$1$1$1.Cache || MapCache$1$1$1$1)();
  return memoized;
} // Expose `MapCache`.


memoize$1$1$1$1.Cache = MapCache$1$1$1$1;
/** Used as the maximum memoize cache size. */

var MAX_MEMOIZE_SIZE$1$1$1$1 = 500;
/**
 * A specialized version of `_.memoize` which clears the memoized function's
 * cache when it exceeds `MAX_MEMOIZE_SIZE`.
 *
...
function memoizeCapped$1$1$1$1(func) {
  var result = memoize$1$1$1$1(func, function (key) {
    if (cache.size === MAX_MEMOIZE_SIZE$1$1$1$1) {
      cache.clear();
    }
...
var rePropName$1$1$1$1 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g;
/** Used to match backslashes in property paths. */

var reEscapeChar$1$1$1$1 = /\\(\\)?/g;
/**
 * Converts `string` to a property path array.
 *
 * @private
...
var stringToPath$1$1$1$1 = memoizeCapped$1$1$1$1(function (string) {
  var result = [];
  ...
  string.replace(rePropName$1$1$1$1, function (match, number, quote, subString) {
    result.push(quote ? subString.replace(reEscapeChar$1$1$1$1, '$1') : number || match);
  });
  return result;
});
/**
...
function toString$1$1$1$1(value) {
  return value == null ? '' : baseToString$1$1$1$1(value);
}
/**
 * Casts `value` to a path array if it's not one.
 *
...
function castPath$1$1$1$1(value, object) {
  if (isArray$1$1$1$1(value)) {
    return value;
  }

  return isKey$1$1$1$1(value, object) ? [value] : stringToPath$1$1$1$1(toString$1$1$1$1(value));
}
/** Used as references for various `Number` constants. */


var INFINITY$1$1$1$1$1 = 1 / 0;
/**
 * Converts `value` to a string key if it's not a string or symbol.
 *
 * @private
...
function toKey$1$1$1$1(value) {
  if (typeof value == 'string' || isSymbol$1$1$1$1(value)) {
    return value;
  }

  var result = value + '';
  return result == '0' && 1 / value == -INFINITY$1$1$1$1$1 ? '-0' : result;
}
/**
 * The base implementation of `_.get` without support for default values.
 *
...
function baseGet$1$1$1$1(object, path) {
  path = castPath$1$1$1$1(path, object);
  var index = 0,
      length = path.length;

  while (object != null && index < length) {
    object = object[toKey$1$1$1$1(path[index++])];
  }
...
function get$1$1$1$1(object, path, defaultValue) {
  var result = object == null ? undefined : baseGet$1$1$1$1(object, path);
  return result === undefined ? defaultValue : result;
}
/**
 * Gets the last element of `array`.
...
function isUndefined$1$1$1$1(value) {
  return value === undefined;
}

var ID$1$1$1 = guid_1$1$1$1.create().toString();
var RELEASE_DELAY$1$1$1 = 150;
var EMITTER_FORCE_LAYER_TYPE$1$1$1 = "EMITTER_FORCE_LAYER_TYPE_" + ID$1$1$1;
var EMITTER_TOP_LAYER_TYPE$1$1$1 = "EMITTER_TOP_LAYER_TYPE_" + ID$1$1$1;
var isListenersSet$1$1$1 = false;
var layersMap$1$1$1 = [];
var listenersLayers$1$1$1 = [];
var listenersPredefinedLayers$1$1$1 = {};
var forceListeners$1$1$1 = [];

var onEvent$1$1$1 = function (e, type) {
  forceListeners$1$1$1.forEach(function (listener) {
    get$1$1$1$1(listener, type, noop$1$1$1$1)(e);
  });

  if (listenersLayers$1$1$1.length) {
    get$1$1$1$1(last$1$1$1$1(listenersLayers$1$1$1), type, noop$1$1$1$1)(e);
  } else {
    var layers = Object.keys(listenersPredefinedLayers$1$1$1).filter(function (key) {
      return listenersPredefinedLayers$1$1$1[Number(key)].length > 0;
    }).sort(function (a, b) {
      return Number(a) - Number(b);
    });
    (listenersPredefinedLayers$1$1$1[Number(last$1$1$1$1(layers))] || []).forEach(function (listener) {
      get$1$1$1$1(listener, type, noop$1$1$1$1)(e);
    });
  }
};

var clearTargetDownLists$1$1$1 = function (target) {
  target.forEach(function (item) {
    item.instance.clearDownList();
  });
};

var onPress$1$1$1 = function (e) {
  onEvent$1$1$1(e, 'onPress');
};

var onDown$1$1$1 = function (e) {
  onEvent$1$1$1(e, 'onDown');
};

var onUp$1$1$1 = function (e) {
  onEvent$1$1$1(e, 'onUp');
};

var onWindowBlur$1$1$1 = function () {
  clearTargetDownLists$1$1$1(listenersLayers$1$1$1);
  clearTargetDownLists$1$1$1(forceListeners$1$1$1);
  Object.keys(listenersPredefinedLayers$1$1$1).forEach(function (key) {
    return clearTargetDownLists$1$1$1(listenersPredefinedLayers$1$1$1[Number(key)]);
  });
};
...
function () {
  ...
  function Emitter(subscribeType, releaseDelay) {
    ...
    if (releaseDelay === void 0) {
      releaseDelay = RELEASE_DELAY$1$1$1;
    }

    this.id = guid_1$1$1$1.create().toString();
    this.downList = [];
    this.releaseDictionary = {};
    this.pressReleaseDictionary = {};
    this.keyDownListeners = [];
    ...
    this.subscribeType = subscribeType || EMITTER_TOP_LAYER_TYPE$1$1$1;
    this.releaseDelay = releaseDelay;
    Emitter.setGeneralListeners();
    this.addListeners();
  }
  ...
  Emitter.setLayersMap = function (firstParam, secondParam) {
    ...
    if (isArray$1$1$1$1(firstParam) && firstParam.length === 2 && typeof firstParam[0] === 'string' && typeof firstParam[1] === 'number') {
      return Emitter.setLayersMap(firstParam[0], firstParam[1]);
    }

    if (isArray$1$1$1$1(firstParam) && firstParam.length === 2 && typeof firstParam[0] === 'number' && typeof firstParam[1] === 'string') {
      return Emitter.setLayersMap(firstParam[0], firstParam[1]);
    }

    if (isArray$1$1$1$1(firstParam) && isUndefined$1$1$1$1(secondParam)) {
      var setCount_1 = 0;
      firstParam.forEach(function (layerMap) {
        setCount_1 += Number(Emitter.setLayerMap(layerMap));
      });
    ...
    if (!isArray$1$1$1$1(firstParam) && typeof firstParam === 'object' && !isUndefined$1$1$1$1(firstParam.name) && !isUndefined$1$1$1$1(firstParam.id)) {
      return Number(Emitter.setLayerMap(firstParam));
    }

    if (!isArray$1$1$1$1(firstParam) && typeof firstParam === 'object') {
      var setCount_2 = 0;
      Object.keys(firstParam).forEach(function (key) {
        var id = firstParam[key];
        setCount_2 += Number(Emitter.setLayerMap({
  ...
  Emitter.setLayerMap = function (data) {
    if (typeof data === 'object' && !isArray$1$1$1$1(data)) {
      return Emitter.setLayerMapFromObject(data);
    }

    if (isArray$1$1$1$1(data)) {
      return Emitter.setLayerMapFromArray(data);
    }
  ...
  Emitter.setGeneralListeners = function () {
    if (!isListenersSet$1$1$1) {
      window.addEventListener('keypress', onPress$1$1$1, true);
      window.addEventListener('keyup', onUp$1$1$1, true);
      window.addEventListener('keydown', onDown$1$1$1, true);
      window.addEventListener('blur', onWindowBlur$1$1$1, true);
      isListenersSet$1$1$1 = true;
    }
  };
  ...
  Emitter.checkInputTarget = function (e) {
    return ['INPUT', 'TEXTAREA'].includes(get$1$1$1$1(e, 'target.tagName'));
  };
  ...
  Emitter.getListenersTarget = function (subscribeType) {
    if (typeof subscribeType === 'number') {
      if (!listenersPredefinedLayers$1$1$1[subscribeType]) {
        listenersPredefinedLayers$1$1$1[subscribeType] = [];
      }

      return listenersPredefinedLayers$1$1$1[subscribeType];
    }

    if (subscribeType === EMITTER_FORCE_LAYER_TYPE$1$1$1) {
      return forceListeners$1$1$1;
    }

    if (subscribeType === EMITTER_TOP_LAYER_TYPE$1$1$1) {
      return listenersLayers$1$1$1;
    }

    if (typeof subscribeType === 'string') {
      var layerId = get$1$1$1$1(layersMap$1$1$1.find(function (item) {
        return item.name === subscribeType;
      }), 'id');
  ...
  Emitter.clearDownLists = function (subscribeType) {
    if (subscribeType === EMITTER_TOP_LAYER_TYPE$1$1$1) {
      Emitter.clearLayerDownLists();
      Emitter.clearPredefinedLayersDownLists();
    } else if (subscribeType === 'string' && subscribeType !== EMITTER_FORCE_LAYER_TYPE$1$1$1 || typeof subscribeType === 'number') {
      var layerId = typeof subscribeType === 'string' ? get$1$1$1$1(layersMap$1$1$1.find(function (item) {
        return item.name === subscribeType;
      }), 'id') : subscribeType;
      var biggestLayerId = Math.max.apply(null, Object.keys(listenersPredefinedLayers$1$1$1).map(function (key) {
        return Number(key);
      }));
  ...
  Emitter.clearPredefinedLayersDownLists = function (skip) {
    ...
    Object.keys(listenersPredefinedLayers$1$1$1).forEach(function (key) {
      ...
      if (!skip.includes(normalizedKey)) {
        clearTargetDownLists$1$1$1(listenersPredefinedLayers$1$1$1[normalizedKey]);
      }
    });
  };
...
const BASE_PLUGIN_NAME$1$1$1 = 'base';

class Plugin$1$1$1 {
    constructor() {
        this.name = BASE_PLUGIN_NAME$1$1$1;
    }
    setTermInfo(termInfo, keyboardShortcutsManager) {
        this.termInfo = termInfo;
        this.keyboardShortcutsManager = keyboardShortcutsManager;
...
/** Detect free variable `global` from Node.js. */
var freeGlobal$2$1$1$1 = typeof global == 'object' && global && global.Object === Object && global;

/** Detect free variable `self`. */

var freeSelf$2$1$1$1 = typeof self == 'object' && self && self.Object === Object && self;
/** Used as a reference to the global object. */

var root$2$1$1$1 = freeGlobal$2$1$1$1 || freeSelf$2$1$1$1 || Function('return this')();

/** Built-in value references. */

var Symbol$2$1$1$1 = root$2$1$1$1.Symbol;

/** Used for built-in method references. */

var objectProto$h$1$1$1 = Object.prototype;
/** Used to check objects for own properties. */

var hasOwnProperty$e$1$1$1 = objectProto$h$1$1$1.hasOwnProperty;
/**
 * Used to resolve the
 * [`toStringTag`](http://ecma-international.org/ecma-262/7.0/#sec-object.prototype.tostring)
 * of values.
...
var nativeObjectToString$3$1$1$1 = objectProto$h$1$1$1.toString;
/** Built-in value references. */

var symToStringTag$3$1$1$1 = Symbol$2$1$1$1 ? Symbol$2$1$1$1.toStringTag : undefined;
/**
 * A specialized version of `baseGetTag` which ignores `Symbol.toStringTag` values.
 *
 * @private
...
function getRawTag$2$1$1$1(value) {
  var isOwn = hasOwnProperty$e$1$1$1.call(value, symToStringTag$3$1$1$1),
      tag = value[symToStringTag$3$1$1$1];

  try {
    value[symToStringTag$3$1$1$1] = undefined;
    var unmasked = true;
  } catch (e) {}

  var result = nativeObjectToString$3$1$1$1.call(value);

  if (unmasked) {
    if (isOwn) {
      value[symToStringTag$3$1$1$1] = tag;
    } else {
      delete value[symToStringTag$3$1$1$1];
    }
  }
...
function objectToString$2$1$1$1(value) {
  return nativeObjectToString$4.call(value);
}

/** `Object#toString` result references. */

var nullTag$2$1$1$1 = '[object Null]',
    undefinedTag$2$1$1$1 = '[object Undefined]';
/** Built-in value references. */

var symToStringTag$4 = Symbol$2$1$1$1 ? Symbol$2$1$1$1.toStringTag : undefined;
/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
...
function baseGetTag$2$1$1$1(value) {
  if (value == null) {
    return value === undefined ? undefinedTag$2$1$1$1 : nullTag$2$1$1$1;
  }

  return symToStringTag$4 && symToStringTag$4 in Object(value) ? getRawTag$2$1$1$1(value) : objectToString$2$1$1$1(value);
}
 ...
 * // => false
 */
function isObjectLike$2$1$1$1(value) {
  return value != null && typeof value == 'object';
}
 ...
 * // => false
 */
var isArray$2$1$1$1 = Array.isArray;
 ...
 * // => [undefined, undefined]
 */
function noop$2$1$1$1() {// No operation performed.
}

/** `Object#toString` result references. */

var stringTag$4$1$1$1 = '[object String]';
/**
 * Checks if `value` is classified as a `String` primitive or object.
 *
 * @static
...
function isString$1$1$1$1(value) {
  return typeof value == 'string' || !isArray$2$1$1$1(value) && isObjectLike$2$1$1$1(value) && baseGetTag$2$1$1$1(value) == stringTag$4$1$1$1;
}

var template$1$1$1$1 = "<div ref=\"root\" class=\"root\"></div>\n";

var css = {"root":"root-context-menu-plugin-️74022d6f2c3e8e38c498d8c8405a8378"};

class ContextMenuView extends TemplateEngine$1$1$1 {
    constructor(container) {
        super(template$1$1$1$1, container);
        this.reRender = false;
    }
    render() {
...
class ContextMenu extends Plugin$1$1$1 {
    constructor() {
        super(...arguments);
    ...
    render(content) {
        ...
        this.isVisible = false;
        return isString$1$1$1$1(content) ? root.innerHTML = content : root.appendChild(content);
    }
    updatePosition() {
...
class Item extends TemplateEngine$1$1 {
    constructor(container, params) {
...
class List extends TemplateEngine$1$1 {
...
class Dropdown extends Plugin$1$1 {
    constructor() {
        super();
...
class Autocomplete extends Plugin$1 {
    constructor() {
        super(...arguments);
