...
import {
  ContextMenu, IContextMenu, END_OF_LINE_TYPE, CLOSE_ACTION,
} from '@term-js/context-menu-plugin';
...
import { NEXT_ACTION, DOWN_ACTION, UP_ACTION, SUBMIT_ACTION } from '@Dropdown/constants/actions';
import {
  DOWN_KEY_CODE,
  ENTER_KEY_CODE,
  TAB_KEY_CODE,
  UP_KEY_CODE,
} from '@Dropdown/constants/keyCodes';
import { PLUGIN_NAME } from '@Dropdown/constants/general';

class Dropdown extends Plugin implements IDropdown {
  public readonly name: string = PLUGIN_NAME;
  public isActionsLock: boolean = false;
