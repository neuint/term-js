...
var css$2$1 = {"root":"index_root__AumwI","visible":"index_visible__3pNIu","content":"index_content__9Rwz7","helpContainer":"index_helpContainer__2PClm","inputContainer":"index_inputContainer__2NU4e"};
...
var css$3$1 = {"root":"index_root__28iIn","carriage-return-blink":"index_carriage-return-blink__3ufcR","lock":"index_lock__10toH","busy":"index_busy__1Bocg","none":"index_none__3BwA2","carriage-return-busy":"index_carriage-return-busy__TLD-_","hidden":"index_hidden__QrtuK"};
...
var css$4$1 = {"root":"index_root__2b6vV","input":"index_input__3ej3X","hiddenCaret":"index_hiddenCaret__1hEUI","hidden":"index_hidden__S0u7d"};

var css$5$1 = {"secret":"index_secret__2YcEB"};
...
var css$6$1 = {"root":"index_root__1UtRO"};
...
var css$7$1 = {"label":"index_label__vyMdB","labelTextContainer":"index_labelTextContainer__10s7C","labelText":"index_labelText__2Tif0"};
...
var symToStringTag$4 = Symbol$2$1 ? Symbol$2$1.toStringTag : undefined;
/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
...
function baseGetTag$2$1(value) {
  ...
  return symToStringTag$4 && symToStringTag$4 in Object(value) ? getRawTag$2$1(value) : objectToString$2$1(value);
}
...
function isString$1$1(value) {
  return typeof value == 'string' || !isArray$2$1(value) && isObjectLike$2$1(value) && baseGetTag$2$1(value) == stringTag$4$1;
}

var template$1$1 = "<div ref=\"root\" class=\"root\"></div>\n";

var css = {"root":"index_root__1O-1I"};

class ContextMenuView extends TemplateEngine$1 {
    constructor(container) {
...
class ContextMenu extends Plugin$1 {
    constructor() {
        super(...arguments);
    ...
    render(content) {
        ...
        this.isVisible = false;
        return isString$1$1(content) ? root.innerHTML = content : root.appendChild(content);
    }
    updatePosition() {
...
const AUTOCOMPLETE_ACTION = 'autocomplete-show';
const AUTOCOMPLETE_NEXT_ACTION = 'autocomplete-next';
const AUTOCOMPLETE_DOWN_ACTION = 'autocomplete-down';
const AUTOCOMPLETE_UP_ACTION = 'autocomplete-up';
const AUTOCOMPLETE_SUBMIT_ACTION = 'autocomplete-submit';

var template$2 = "<ul ref=\"root\" class=\"root\"></ul>\n";

var css$1 = {"root":"index_root__145kr"};

var template$6 = "<li ref=\"root\" class=\"root {active}\">\n  <span class=\"matchText\">{match}</span><span class=\"text\">{suggestion}</span>\n</li>\n";

var css$8 = {"root":"index_root__323L2","active":"index_active__2ehGV","text":"index_text__1N_ot","matchText":"index_matchText__2RxBs"};
...
class Autocomplete extends Plugin {
    ...
    clear() {
        ...
        this.activeSuggestion = '';
        this.isActive = false;
        (_a = this.contextMenuPlugin) === null || _a === void 0 ? void 0 : _a.hide();
        super.clear();
    }
    destroy() {
    ...
    setSuggestions() {
        ...
        if (activeSuggestions.length)
            this.activeSuggestion = activeSuggestions[0];
    ...
    renderSuggestionsList() {
        const { contextMenuPlugin, container, activeSuggestions, keyboardShortcutsManager, unlockCallback, termInfo, } = this;
        const value = termInfo === null || termInfo === void 0 ? void 0 : termInfo.edit.value;
        if (!contextMenuPlugin || !keyboardShortcutsManager || !value)
            return;
        if (!this.list)
            this.list = new List(container, this.onSelect);
        if (!unlockCallback) {
