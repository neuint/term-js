...
var autocompletePlugin = require('@term-js/autocomplete-plugin');
...
class HistorySearch extends term.Plugin {
    ...
    setAutocomplete() {
        ...
        if (!termInfo)
            return;
        const autocomplete = termInfo.pluginManager.getPlugin(autocompletePlugin.Autocomplete);
        if (autocomplete)
            return this.autocomplete = autocomplete;
        this.autocomplete = new autocompletePlugin.Autocomplete();
    ...
    checkUpdateHistoryList() {
        var _a;
        const { history } = this;
        const newHistory = lodashEs.uniq(((_a = this.termInfo) === null || _a === void 0 ? void 0 : _a.history) || []);
